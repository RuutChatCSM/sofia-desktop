{{- define "sofia-ee.name" -}}
{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "sofia-ee.fullname" -}}
...
{{- define "sofia-ee.chart" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "sofia-ee.selectorLabels" -}}
app.kubernetes.io/name: {{ include "sofia-ee.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end -}}

{{- define "sofia-ee.labels" -}}
helm.sh/chart: {{ include "sofia-ee.chart" . }}
{{ include "sofia-ee.selectorLabels" . }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{- end -}}

{{- define "sofia-ee.componentSelectorLabels" -}}
{{ include "sofia-ee.selectorLabels" .root }}
app.kubernetes.io/component: {{ .component }}
{{- end -}}

{{- define "sofia-ee.componentLabels" -}}
{{ include "sofia-ee.labels" .root }}
app.kubernetes.io/component: {{ .component }}
{{- end -}}

{{- define "sofia-ee.configName" -}}
{{ include "sofia-ee.fullname" . }}-config
{{- end -}}

{{- define "sofia-ee.allowPrivateMcpUrls" -}}
...
{{- define "sofia-ee.secretName" -}}
{{- if .Values.secret.existingSecret -}}
{{- .Values.secret.existingSecret -}}
{{- else -}}
{{- include "sofia-ee.fullname" . }}-secret
{{- end -}}
{{- end -}}

{{- define "sofia-ee.denApiServiceName" -}}
{{ include "sofia-ee.fullname" . }}-den-api
{{- end -}}

{{- define "sofia-ee.denWebServiceName" -}}
{{ include "sofia-ee.fullname" . }}-den-web
{{- end -}}

{{- define "sofia-ee.inferenceServiceName" -}}
{{ include "sofia-ee.fullname" . }}-inference
{{- end -}}

{{- define "sofia-ee.denApiInternalUrl" -}}
{{- default (printf "http://%s:%v" (include "sofia-ee.denApiServiceName" .) .Values.denApi.service.port) .Values.config.internal.apiBaseUrl -}}
{{- end -}}

{{- define "sofia-ee.authFallbackInternalUrl" -}}
{{- default (include "sofia-ee.denApiInternalUrl" .) .Values.config.internal.authFallbackBaseUrl -}}
{{- end -}}

{{- define "sofia-ee.inferenceInternalUrl" -}}
{{- default (printf "http://%s:%v" (include "sofia-ee.inferenceServiceName" .) .Values.inference.service.port) .Values.config.internal.inferenceProxyBaseUrl -}}
{{- end -}}

{{- define "sofia-ee.customCa.mountPath" -}}
/etc/sofia/custom-ca
{{- end -}}

{{- define "sofia-ee.customCa.filePath" -}}
{{ include "sofia-ee.customCa.mountPath" . }}/ca-bundle.pem
{{- end -}}

{{- define "sofia-ee.customCa.validate" -}}
...
{{- define "sofia-ee.customCa.volume" -}}
- name: custom-ca
...
{{- define "sofia-ee.customCa.volumeMount" -}}
- name: custom-ca
  mountPath: {{ include "sofia-ee.customCa.mountPath" . | quote }}
  readOnly: true
{{- end -}}

{{- define "sofia-ee.customCa.env" -}}
- name: NODE_EXTRA_CA_CERTS
  value: {{ include "sofia-ee.customCa.filePath" . | quote }}
{{- end -}}

{{- define "sofia-ee.observabilityBackend" -}}
...
{{- define "sofia-ee.observabilityOtelExporter" -}}
...
{{- define "sofia-ee.observabilityOtelSampler" -}}
...
{{- define "sofia-ee.observabilityEnv" -}}
{{- $root := .root -}}
{{- $serviceName := .serviceName -}}
{{- $backend := include "sofia-ee.observabilityBackend" $root -}}
...
{{- if eq $backend "otel" }}
{{- $otelSampler := include "sofia-ee.observabilityOtelSampler" $otel.tracesSampler -}}
...
- name: OTEL_TRACES_EXPORTER
  value: {{ include "sofia-ee.observabilityOtelExporter" (dict "signal" "traces" "value" $otel.exporters.traces) | quote }}
- name: OTEL_METRICS_EXPORTER
  value: {{ include "sofia-ee.observabilityOtelExporter" (dict "signal" "metrics" "value" $otel.exporters.metrics) | quote }}
- name: OTEL_LOGS_EXPORTER
  value: {{ include "sofia-ee.observabilityOtelExporter" (dict "signal" "logs" "value" $otel.exporters.logs) | quote }}
