 ...
 *
 * Usage:
 *   pnpm --filter @sofia-ee/den-db db:baseline              # dry run
 *   pnpm --filter @sofia-ee/den-db db:baseline -- --yes     # apply
 *   pnpm --filter @sofia-ee/den-db db:baseline -- --yes --through 0020_breezy_siren
 *
