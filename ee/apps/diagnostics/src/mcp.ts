import { EGRESS_DIAGNOSTIC_RUN_HEADER } from "@sofia/types/den/egress-diagnostics"
...
export async function handleMcpRequest(request: Request, rawBody: string): Promise<HandledResponse> {
  ...
  if (value.method === "initialize") {
    ...
    return json(200, rpcResult(id, {
      ...
      instructions: "Synthetic Sofia Diagnostics endpoint. No customer content is returned or retained.",
      protocolVersion: version,
      serverInfo: { name: "sofia-diagnostics", version: "1.0.0" },
    }), {
