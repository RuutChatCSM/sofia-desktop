...
export const dataHandlingRows: DataHandlingRow[] = [
  {
    ...
    cloud: "Not stored by Sofia. Accessed at runtime through your LLM provider."
  },
  {
    dataType: "LLM API keys",
    selfHosted: "Local keychain or environment variables",
    cloud: "Held by your LLM provider, not by Sofia"
  },
  {
    dataType: "Prompts & responses",
    selfHosted: "Local only",
    cloud: "Sent to your LLM provider. Not logged by Sofia."
  },
  {
