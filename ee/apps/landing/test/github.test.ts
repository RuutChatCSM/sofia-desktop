...
const repoUrl = "https://api.github.com/repos/RuutChatCSM/sofia-desktop";
const latestReleaseUrl = "https://api.github.com/repos/RuutChatCSM/sofia-desktop/releases/latest";
const releasesUrl = "https://api.github.com/repos/RuutChatCSM/sofia-desktop/releases?per_page=50";
const fallbackReleaseUrl = "https://github.com/RuutChatCSM/sofia-desktop/releases";
...
describe("getGithubData", () => {
  test("selects only public desktop assets when installer assets are listed first", async () => {
    const macArm64 = asset("sofia-mac-arm64-0.17.38.dmg");
    const macX64 = asset("sofia-mac-x64-0.17.38.dmg");
    const winArm64 = asset("sofia-win-arm64-0.17.38.exe");
    const winX64 = asset("sofia-win-x64-0.17.38.exe");
    const linuxX64 = asset("sofia-linux-x86_64-0.17.38.AppImage");
    const release = releaseWithAssets([
      asset("Sofia-Installer-mac-arm64.dmg"),
      asset("Sofia-Installer-mac-x64.dmg"),
      asset("Sofia-Installer-win-x64.exe"),
      asset("sofia-cloud-mac-arm64-0.17.38.dmg"),
      asset("sofia-cloud-mac-x64-0.17.38.dmg"),
      asset("sofia-cloud-win-x64-0.17.38.exe"),
      asset("sofia-cloud-linux-x86_64-0.17.38.AppImage"),
      asset("sofia-enterprise-mac-arm64-0.17.38.dmg"),
      asset("sofia-enterprise-mac-x64-0.17.38.dmg"),
      asset("sofia-enterprise-win-x64-0.17.38.exe"),
      asset("sofia-enterprise-linux-x86_64-0.17.38.AppImage"),
      macArm64,
      macX64,
      winArm64,
      winX64,
