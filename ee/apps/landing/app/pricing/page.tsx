...
const pricingSchema = {
  ...
  name: "Sofia",
  description:
    "Sofia is an open source Claude Cowork alternative — a desktop app for teams to use 50+ LLMs, bring their own keys, and share reusable agent setups with guardrails.",
  brand: { "@type": "Brand", name: "Sofia" },
  offers: [
    {
      "@type": "Offer",
      name: "Solo",
    ...
    },
    {
      "@type": "Offer",
      name: "Enterprise",
      url: "https://sofia.ruut.chat/enterprise",
      description:
...
export const metadata = {
  title: "Sofia Pricing — Free desktop, $10/seat teams, enterprise",
  description:
    "Sofia is free forever for solo use with bring-your-own-keys. Teams get their first 5 seats free, then $10 per seat per month, plus custom enterprise plans with SSO and bring-your-own inference.",
  alternates: {
    canonical: "/pricing"
  },
  openGraph: {
        ...
        <main className="mx-auto flex w-full max-w-6xl flex-col gap-16 px-6 pb-24 md:gap-20 md:px-8 md:pb-28">
          <section className="max-w-4xl pt-6 md:pt-10">
            <h1 className="mb-6 text-4xl font-medium leading-[1.05] tracking-tight md:text-5xl lg:text-6xl">
              Sofia pricing — free, team, and enterprise
            </h1>
          </section>
