...
/**
 * Sofia Cloud instances are served from Daytona preview origins that are
...
const CORS_ALLOW_HEADERS = "authorization,content-type,x-sofia-org-id,x-sofia-legacy-org-id,x-request-id,accept";
