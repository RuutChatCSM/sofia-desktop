...
const SOFIA_MARK_SRC = "/sofia-mark.svg";
...
function BrandIcon({ iconUrl }: { iconUrl: string | null }) {
  ...
  const iconSrc = iconUrl && iconUrl !== failedIconUrl ? iconUrl : SOFIA_MARK_SRC;
  const isFallbackIcon = iconSrc === SOFIA_MARK_SRC;
