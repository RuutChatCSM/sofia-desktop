...
export const PENDING_ORG_INVITATION_STORAGE_KEY = "sofia:web:pending-org-invitation";
export const PENDING_WORKSPACE_CLAIM_STORAGE_KEY = "sofia:web:pending-workspace-claim";
export const PENDING_ORG_SELECTION_STORAGE_KEY = "sofia:web:pending-org-selection";
...
export function parseInvitationPreviewPayload(payload: unknown): DenInvitationPreview | null {
  ...
  return {
    ...
    organization: {
      ...
      allowedEmailDomains: asStringArray(organization.allowedEmailDomains),
      branding: {
        appName: asString(branding?.appName) ?? "Sofia",
