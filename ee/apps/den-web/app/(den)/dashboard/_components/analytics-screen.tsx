  ...
  return (
    <div className="mx-auto max-w-[1100px] px-4 pb-8 pt-4 sm:px-6 md:px-8">
      ...
      <div className="flex flex-wrap items-center gap-2.5 border-b border-[#e7e9f0] pb-3">
        <span className="text-[14px] font-semibold tracking-[-0.01em] text-[#07192C]">{activeOrg?.name ?? "Sofia Cloud"}</span>
      ...
      <p className="mt-1 text-[14px] leading-6 text-[#5A6886]">
        See how your team is adopting Sofia — active members, sessions, and task activity over time.
      ...
      <p className="mt-5 text-[12px] leading-5 text-[#9AA5BA]">
        ...
        Usage data appears here once members sign in to the Sofia app and start running tasks.
      </p>
      </>
      )}
    </div>
