...
export function MarketplacesScreen() {
  ...
  return (
    <DashboardPageTemplate
      icon={Store}
      title="Collections"
      description="Collections contain plugins. The built-in Sofia collection and assigned collections show up inside the desktop app after sign-in."
...
function ConnectIntegrationEmptyState({ integrationsHref }: { integrationsHref: string }) {
  return (
    <EmptyState
      ...
      description="Collections are created when Sofia finds plugins in a connected repository. Assign them to everyone in your org or specific users and teams."
