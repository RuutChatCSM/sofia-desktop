...
function seedRequiredEnv() {
  process.env.DATABASE_URL = process.env.DATABASE_URL ?? "mysql://root:password@127.0.0.1:3306/sofia_test_pr8"
  ...
  await db.insert(schema.ConfigObjectVersionTable).values([
    {
      ...
      normalizedPayloadJson: { mcpServers: { legacy: { sofiaManaged: "den_external_mcp", externalMcpConnectionId: legacyConnectionId, url: "https://legacy.example.test/mcp" } } },
      rawSourceText: null,
