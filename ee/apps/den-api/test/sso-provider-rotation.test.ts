...
function seedRequiredEnv() {
  process.env.DATABASE_URL = process.env.DATABASE_URL ?? "mysql://root:password@127.0.0.1:3306/sofia_test_sso_provider_rotation"
...
const canonicalProviderIds = {
  first: `sofia-sso-${firstOrganizationId}`,
  recovery: `sofia-sso-${recoveryOrganizationId}`,
}
