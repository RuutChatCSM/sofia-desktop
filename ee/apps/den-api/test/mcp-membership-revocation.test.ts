...
beforeAll(async () => {
  ...
  mock.module("../src/auth.js", () => ({
    ...
    DEN_MCP_GRANT_ID_CLAIM: "https://sofia.ruut.chat/grant_id",
...
function validMcpJwtPayload(input: { resource: string; clientId?: string }) {
  return {
    ...
    "https://sofia.ruut.chat/token_use": "mcp",
    "https://sofia.ruut.chat/resource": input.resource,
    "https://sofia.ruut.chat/org_id": createDenTypeId("organization"),
...
test("MCP JWTs without required scopes return insufficient_scope", async () => {
  jwtPayload = {
    ...
    scope: "profile",
    "https://sofia.ruut.chat/token_use": "mcp",
    "https://sofia.ruut.chat/resource": "http://127.0.0.1:8790/mcp/agent",
    "https://sofia.ruut.chat/org_id": createDenTypeId("organization"),
    sid: createDenTypeId("session"),
  }
...
test("MCP JWTs with the wrong token use are rejected as invalid_token", async () => {
  jwtPayload = {
    ...
    azp: "client_mcp_test",
    scope: "mcp:read",
    "https://sofia.ruut.chat/token_use": "session",
    "https://sofia.ruut.chat/resource": "http://127.0.0.1:8790/mcp/agent",
    "https://sofia.ruut.chat/org_id": createDenTypeId("organization"),
    sid: createDenTypeId("session"),
  }
...
test("MCP JWTs for the wrong resource are rejected as invalid_token", async () => {
  jwtPayload = {
    ...
    scope: "mcp:read",
    "https://sofia.ruut.chat/token_use": "mcp",
    "https://sofia.ruut.chat/resource": "http://127.0.0.1:8790/mcp",
    "https://sofia.ruut.chat/org_id": createDenTypeId("organization"),
    sid: createDenTypeId("session"),
  }
