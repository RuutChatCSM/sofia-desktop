...
describe("getMcpResourceUrl", () => {
  ...
  test("auto-trusts a path-prefixed public API resource", () => {
    runMcpResourceProbe({
      betterAuthUrl: "https://app.example.com",
      apiPublicUrl: "https://sofia.example/api/den",
      route: "agent",
      requestUrl: "https://sofia.example/api/den/mcp/agent",
      expectedResource: "https://sofia.example/api/den/mcp/agent",
      expectedMetadataUrl: "https://sofia.example/.well-known/oauth-protected-resource/api/den/mcp/agent",
      metadataUrl: "https://sofia.example/api/den/mcp/agent",
      expectedMetadataResource: "https://sofia.example/api/den/mcp/agent",
      expectedAuthorizationServer: "https://app.example.com/api/auth",
    })
  })
