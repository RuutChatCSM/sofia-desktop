...
process.env.DATABASE_URL = process.env.DATABASE_URL ?? "mysql://root:password@127.0.0.1:3306/sofia_test_meaccess"
...
const sourceRepositoryUrl = "https://github.com/sofialabs/member-library"
