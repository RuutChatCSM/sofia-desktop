...
import { and, count, desc, eq, inArray, isNotNull, isNull, lt, lte, or, sql } from "@sofia-ee/den-db/drizzle"
import { AuthAccountTable, AuthUserTable, ExternalIdentityTable, MemberTable, ScimGroupMemberTable, ScimGroupTable, ScimProviderTable, ScimSyncEventTable, ScimUserTombstoneTable } from "@sofia-ee/den-db/schema"
...
export function buildOrganizationScimProviderId(organizationId: OrganizationId) {
  return `sofia-scim-${organizationId}`
}
