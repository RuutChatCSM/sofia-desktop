const DEVELOPMENT_CONDITIONS_REEXEC = "SOFIA_DEN_DEVELOPMENT_CONDITIONS_REEXEC"
...
if (process.env.SOFIA_DEV_MODE === "1" && process.env[DEVELOPMENT_CONDITIONS_REEXEC] !== "1") {
