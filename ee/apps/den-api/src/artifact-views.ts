import { and, desc, eq, isNull } from "@sofia-ee/den-db/drizzle"
import { ArtifactViewRevisionTable, ArtifactViewTable } from "@sofia-ee/den-db/schema"
import { createDenTypeId, normalizeDenTypeId, type DenTypeId } from "@sofia-ee/utils/typeid"
import type { GeneratedArtifactView, GeneratedArtifactViewRevision } from "@sofia/types/workflows"
