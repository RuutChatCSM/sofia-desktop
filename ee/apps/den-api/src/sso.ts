import { and, eq, isNotNull, isNull } from "@sofia-ee/den-db/drizzle"
import { AuthAccountTable, ExternalIdentityTable, SsoConnectionTable, SsoProviderTable } from "@sofia-ee/den-db/schema"
...
export function buildOrganizationSsoProviderId(organizationId: OrganizationId) {
  return `sofia-sso-${organizationId}`
}
