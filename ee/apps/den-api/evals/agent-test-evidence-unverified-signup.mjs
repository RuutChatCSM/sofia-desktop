// Live E2E test evidence for the "unverified, but usable" onboarding boundary.
//
...
//   DATABASE_URL=mysql://root:password@127.0.0.1:33307/sofia_agent_signup
//
...
import { AuthUserTable } from "@sofia-ee/den-db/schema"
...
// Frame 7 — the published start.md matches the live flow.
{
  ...
  const text = await readFile(startPath, "utf8")
...
<title>Unverified Agent Signup — live E2E test evidence</title>
