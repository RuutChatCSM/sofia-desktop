...
const DEMO_OWNER_PASSWORD = process.env.DEN_DEMO_OWNER_PASSWORD?.trim() || "SofiaDemo123!"
...
function assertSafeDevTarget() {
  if (!env.devMode) {
    throw new Error("Refusing to seed demo data unless SOFIA_DEV_MODE=1.")
  }
  if (env.dbMode !== "mysql") {
...
function githubHeaders() {
  return {
    ...
    "User-Agent": "sofia-den-demo-seed",
