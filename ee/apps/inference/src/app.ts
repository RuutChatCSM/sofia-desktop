...
import { sql } from "@sofia-ee/den-db/drizzle";
...
const shouldServeLocalModelCatalog = !isVercelRuntime && (process.env.NODE_ENV !== "production" || process.env.SOFIA_DEV_MODE === "1");
