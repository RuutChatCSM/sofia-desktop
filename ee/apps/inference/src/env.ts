import "./load-env.js";
import type { DenDbMode, PlanetScaleCredentials } from "@sofia-ee/den-db";
import { z } from "zod";
...
export const isDevMode = process.env.SOFIA_DEV_MODE === "1";
...
const parsed = EnvSchema.parse({
  ...
  DATABASE_URL:
    ...
    (isDevMode
      ? "mysql://root:password@127.0.0.1:3306/sofia_den"
      : undefined),
