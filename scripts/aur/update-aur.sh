...
VERSION="${TAG#v}"
ASSET_NAME_AMD64="${AUR_ASSET_NAME:-sofia-linux-x64-${VERSION}.tar.gz}"
ASSET_NAME_ARM64="sofia-linux-arm64-${VERSION}.tar.gz"
ASSET_URL_AMD64="https://github.com/RuutChatCSM/sofia-desktop/releases/download/${TAG}/${ASSET_NAME_AMD64}"
ASSET_URL_ARM64="https://github.com/RuutChatCSM/sofia-desktop/releases/download/${TAG}/${ASSET_NAME_ARM64}"
