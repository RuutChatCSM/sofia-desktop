...
const POSTHOG_DISTINCT_ID = process.env.POSTHOG_DISTINCT_ID || "sofia-download"
const GITHUB_REPO = process.env.GITHUB_REPO || "RuutChatCSM/sofia-desktop"
...
async function fetchReleases() {
  ...
  const headers = {
    ...
    "User-Agent": "sofia-download-stats",
  }
