...
**2. ★ Member discovers it in Sofia Connect** (`desktop-org-mcp-connect.png`)
...
1. Rework: org connections render in Sofia Connect as organization rows.
...
3. Callback arrival page copy ("Connected — return to Sofia"). The
