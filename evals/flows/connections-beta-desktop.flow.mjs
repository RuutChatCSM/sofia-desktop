...
const WORKSPACE_PATH = "/tmp/sofia-connections-beta-desktop";
      ...
      run: async (ctx) => {
        await ctx.prove("The org tool appears in Connect as needing the member's sign-in", {
          ...
          screenshot: {
            ...
            claim: "Sofia Connect shows the org MCP connection under Needs your sign-in with Connect your account.",
