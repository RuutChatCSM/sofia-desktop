...
async function openDesktopVersionSettings(ctx) {
  ...
  await ctx.waitFor(`document.body.innerText.includes('Start using Sofia') && Boolean(document.querySelector('input[type="email"]'))`, {
    timeoutMs: 30_000,
...
export default {
  ...
  kind: "user-facing",
  preserveTheme: true,
  requiredEnv: ["SOFIA_EVAL_DEN_WEB_URL"],
  steps: [
    {
