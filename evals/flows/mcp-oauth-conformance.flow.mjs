...
const MOCK_PORT = Number(process.env.SOFIA_EVAL_MCP_OAUTH_PORT ?? 39728);
...
function authHeaders() {
  return {
    ...
    "x-sofia-org-id": requireState(state.organizationId, "organization id"),
  };
}
...
export default {
  ...
  steps: [
    ...
    },
    {
      ...
      run: async (ctx) => {
        await ctx.prove("Dynamic registration identifies Sofia as a web client and completes through one shared callback", {
          voiceover: vo[1],
          action: async () => {
