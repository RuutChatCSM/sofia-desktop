/**
 * Portable extensions export: an installed skill and an Sofia-managed
...
// In-page Sofia server access using the app's own connection details.
      ...
      run: async (ctx) => {
        await ctx.prove("Runtime-managed MCP appears in Settings > Extensions", {
          action: async () => {
            ...
            // (POST /workspace/:id/mcp); stored in the Sofia runtime DB,
