...
export default {
  ...
  // SOFIA_EVAL_DAYTONA_SANDBOX is required (not optional, unlike
  ...
  requiredEnv: ["SOFIA_EVAL_DEN_API_URL", "SOFIA_EVAL_DEN_TOKEN", "SOFIA_EVAL_DEN_WEB_URL", "SOFIA_EVAL_DAYTONA_SANDBOX"],
  steps: [
    {
      name: "setup",
      run: async (ctx) => {
