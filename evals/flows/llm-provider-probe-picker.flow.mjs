 ...
 *
 * Required env:
 * - SOFIA_EVAL_DEN_WEB_URL   Den web origin (e.g. http://localhost:3015)
 * - SOFIA_EVAL_DEN_EMAIL     Seeded user email (sign-in fallback)
 * - SOFIA_EVAL_DEN_PASSWORD  Seeded user password (sign-in fallback)
 */
...
export default {
  ...
  requiredEnv: ["SOFIA_EVAL_DEN_WEB_URL", "SOFIA_EVAL_DEN_EMAIL", "SOFIA_EVAL_DEN_PASSWORD"],
  steps: [
    {
