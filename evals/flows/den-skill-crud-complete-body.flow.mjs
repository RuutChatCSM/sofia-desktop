...
const ADMIN_EMAIL =
  process.env.SOFIA_EVAL_DEMO_EMAIL?.trim() || "alex@acme.test";
const ADMIN_PASSWORD =
  process.env.SOFIA_EVAL_DEMO_PASSWORD?.trim() || "SofiaDemo123!";
