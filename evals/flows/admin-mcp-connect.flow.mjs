 ...
 *   3. Connect "Sofia Admin Analytics".
 ...
 *
 * Required env:
 * - SOFIA_EVAL_DEN_API_URL  Den API base (the fixed sandbox Den)
 * - SOFIA_EVAL_DEN_TOKEN    Bearer session token for the admin account
 */

const ADMIN_TITLE = "Sofia Admin Analytics";
      ...
      run: async (ctx) => {
        ...
        await ctx.prove("The hidden admin MCP entry is discoverable after Show hidden", {
          ...
          screenshot: {
            ...
            claim: "Sofia Admin Analytics appears in MCP settings after Show hidden.",
      ...
      run: async (ctx) => {
        ...
        await ctx.prove("The admin MCP attaches and shows Connected", {
          ...
          screenshot: {
            ...
            claim: "Sofia Admin Analytics shows Connected — admin MCP attached end-to-end.",
