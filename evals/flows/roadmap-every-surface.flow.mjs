...
export default {
  id: FLOW_ID,
  title: "The Sofia roadmap presents desktop as home and the same workspace on every surface",
  kind: "user-facing",
  ...
  steps: [
        ...
        await ctx.prove("The roadmap goes directly from its introduction into the dated product sections without the unclear system diagram.", {
          ...
          assert: async () => {
            const actual = await ctx.eval(`(() => {
              const roadmap = document.querySelector('[data-testid="sofia-roadmap"]');
    ...
    },
    {
      name: "Frame 3",
      run: async (ctx) => {
        await ctx.prove("The portability section shows how the desktop setup travels through Sofia Connect.", {
          voiceover: vo[2],
          action: async () => {
          ...
          screenshot: {
            ...
            requireText: ["your setup follows you", "Sofia Connect MCP", "Git-based publishing"],
            rejectText: ["Something went wrong"],
          },
        });
      },
        ...
        await ctx.prove("The surfaces section makes the sequence from desktop to Slack, mobile, and beyond explicit.", {
          ...
          assert: async () => {
            ...
            recordAssertion(
              ...
              actual.exists === true
                && actual.text.includes("Sofia on every surface")
                && actual.text.includes("Sofia desktop")
          ...
          screenshot: {
            ...
            requireText: ["Sofia on every surface", "Slack", "Mobile", "Exploring"],
            rejectText: ["Something went wrong"],
          },
        });
      },
