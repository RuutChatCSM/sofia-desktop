        ...
        await ctx.prove("Landing on the sign-in page mid desktop handoff shows the signed-in card, not a password form", {
          ...
          assert: async () => {
            await ctx.waitFor(`(() => {
              ...
              return text.includes("You're signed in.") && text.includes("Go to dashboard") && text.includes("Open Sofia") && location.pathname === "/";
          ...
          screenshot: {
            ...
            requireText: ["You're signed in.", "Go to dashboard", "Open Sofia"],
