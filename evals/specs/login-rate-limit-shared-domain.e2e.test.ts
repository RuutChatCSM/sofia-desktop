...
const title = !e2eTestsEnabled
  ? "shared-domain login rate limit skipped — needs: set SOFIA_EVAL_E2E_TESTS=1"
  : !localPlacement
    ? "shared-domain login rate limit skipped — needs local placement without SOFIA_EVAL_DEN_API_URL"
    : !mysqlOpen
