...
End-to-end flows where the **agent itself** (composer prompts) operates Sofia
Cloud through the `sofia-cloud` MCP. These validate the real product story:
...
3. Open Settings -> Extensions -> MCP and wait for **Sofia Cloud Control —
...
**Prompt:** "Which Sofia Cloud organization am I connected to? Use your
sofia-cloud tools to check."
...
**Prompt:** "Add omar@ruut.chat to my organization as a member using
your sofia-cloud tools."
...
**Prompt:** "Assign <member> to the Sales team using your sofia-cloud tools."
...
organization using the proper Sofia Cloud way: create a plugin containing
...
`weekly-report` in Sofia Marketplace.
