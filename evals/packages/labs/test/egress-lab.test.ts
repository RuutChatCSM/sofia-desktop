...
import { productDiagnosticsPrecondition } from "@sofia/behaviors";
...
test("openssl argv construction includes CA, AIA, and fullchain prerequisites", () => {
  ...
  assert.ok(commands.some((command) => command.args.includes("/CN=Sofia App Egress Lab Corporate Interception CA")));
