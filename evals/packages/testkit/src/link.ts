...
import { checkedExec, defaultDaytonaExec } from "@sofia/hosts";
import type { ChildProcess } from "node:child_process";
import type { DenRef } from "@sofia/behaviors";
import type { DaytonaExec } from "@sofia/hosts";

const DAYTONA_LINK_SCRIPT = "/tmp/sofia-den-link-server.mjs";
const DAYTONA_LINK_PID = "/tmp/sofia-den-link-server.pid";
