...
2. The eval creates benchmark-prefixed workspaces and real OpenCode sessions through Sofia's own APIs, then proves the loaded app can still switch between those sessions quickly.
