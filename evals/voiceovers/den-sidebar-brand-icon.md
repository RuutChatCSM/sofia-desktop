...
1. I open Den while organization branding is loading, and the sidebar icon stays visually stable without a broken image or a flash of the generic Sofia mark.

2. Once branding is available, Den's sidebar shows the configured square organization icon instead of the generic Sofia mark.
