...
3. On a teammate's desktop the app is just running — and within moments its icon in the taskbar switches from the Sofia mark to our company icon, no restart needed.
...
6. Back in the dashboard I clear the Icon URL, and the running app's icon returns to the stock Sofia mark on its own.
