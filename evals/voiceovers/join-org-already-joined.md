...
3. The teammate clicks the same emailed invite link again — instead of the old "This invite has already been used." dead-end, Sofia recognizes the membership and opens the team workspace.
