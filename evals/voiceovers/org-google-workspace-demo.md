...
Cast reuses the org MCP demo — Alex (org admin, Sofia Cloud) and Jordan
...
1. Alex runs IT for Acme. In Sofia Cloud, he sets up Google Workspace once for the whole company — pasting in the Google app Acme already owns and trusts. No employee will ever see this screen.
...
3. She clicks it, and her real browser opens Google's consent screen for Acme's own app. One approve, and she's back in Sofia — her sign-in kept safely in the company cloud, not in a file on her laptop.
