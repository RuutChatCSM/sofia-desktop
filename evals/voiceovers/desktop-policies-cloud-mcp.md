# desktop-policies-cloud-mcp — Admins edit desktop policies straight from the agent, through Sofia Cloud
...
Sofia Cloud MCP rail (`/mcp/agent`, `search_capabilities` +
...
1. I'm an org admin and I don't open a dashboard — I ask through Sofia Cloud, and capability search comes back with the desktop policy tools.
...
5. A member's Sofia picks up the new config on its own, and custom providers are now locked on their desktop.
