...
This is an internal proof: the protagonist is the OAuth grant behind an MCP connection, driven through Sofia's real token endpoint and resource handler at the wire level.
