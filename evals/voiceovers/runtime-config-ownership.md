...
1. When something looks wrong with my agent's config today, I have to guess — changes land partly in Sofia's managed file and partly in my personal OpenCode files, and old versions left ghosts in both.
