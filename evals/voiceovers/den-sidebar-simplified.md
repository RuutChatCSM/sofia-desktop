...
Cast is Alex (org admin) and Jordan (member), in Sofia Cloud (den-web).
...
4. Models next: the managed Sofia Models plan and the company own provider keys, side by side — one place to answer what the org can run.
