...
1. I'm in Sofia, and Sarah's thread about the Q3 launch has been going back and forth for days. I ask Sofia to reply to her latest email and confirm that Thursday works.

2. Sofia reads the thread through my connected Google account first, so the reply is written in context — it knows who said what and where the conversation left off.
...
6. And Sofia finishes by handing me the link — one click opens the ready-to-send draft in Gmail, and I hit send myself.
