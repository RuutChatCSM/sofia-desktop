...
1. A Windows teammate launches Sofia and the stock icon is visible in the real taskbar.
...
4. After closing and relaunching Sofia, the branded icon appears from the first visible window.

5. Clearing the organization icon restores the stock Sofia icon.
