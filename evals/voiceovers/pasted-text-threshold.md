...
1. Before selecting a task, I paste text that would make the centered composer scroll, and Sofia shows it as a compact chip.

2. I expand that chip, and the full paste returns as normal editable text without a special highlight.

3. Inside a task, I paste text that would make the composer scroll, and Sofia keeps the composer tidy with the same compact chip.
...
7. I paste a standalone URL with no spaces, and Sofia recognizes it as a link rather than collapsing it into a chip.
