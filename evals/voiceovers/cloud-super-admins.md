...
1. The sidebar documents the workspace areas clearly: Extensions contains Marketplace, Sources, Plugins, and Connectors; Models contains Sofia Models and LLM Providers; Members and Analytics stand alone; Settings contains General, Diagnostics, Brand appearance, Desktop Policies, Stripe, API Keys, SSO, and SCIM.
