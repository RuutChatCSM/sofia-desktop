...
3. Playing a Cursor-like client, I register via dynamic client registration with a loopback redirect and get sent to the real Sofia sign-in page to authorize.
