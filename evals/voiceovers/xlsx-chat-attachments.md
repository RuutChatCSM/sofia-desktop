...
1. I attach an Excel `.xlsx` workbook to a chat, and Sofia accepts it like Word and PowerPoint files.

2. The attachment appears as an XLSX file card with its original filename and remains downloadable without modification.

3. I send the message, and Sofia preserves the original workbook while exposing cell values, formulas, formatting, and workbook structure to the assistant.
