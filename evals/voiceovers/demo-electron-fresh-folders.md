...
1. I run `pnpm demo:electron`, and two Sofia demo windows launch together.

2. Each window uses its own newly created temporary folder, completely separate from the production Sofia data directory.
