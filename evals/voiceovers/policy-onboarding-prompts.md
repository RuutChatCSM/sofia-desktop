...
1. By default, Sofia provides the task suggestions shown in every empty session.
...
5. Members covered by that policy now see the organization-provided prompts instead of Sofia's defaults. Everyone else continues seeing the local Sofia suggestions.
