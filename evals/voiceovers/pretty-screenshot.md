...
2. Here is the same app state twice: first the plain capture, then the pretty capture — the app framed on the paper mesh-gradient background in Sofia's brand palette.
