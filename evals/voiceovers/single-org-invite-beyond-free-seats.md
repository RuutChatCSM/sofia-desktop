...
This user-facing demo follows Alex, the admin of a self-hosted single-org Sofia deployment. The workspace already has more members than the hosted free tier, which used to dead-end every new invite behind a seat-billing paywall the operator could never resolve.
