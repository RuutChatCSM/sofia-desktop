...
1. “I add a remote MCP from Extensions and choose Sofia-managed sign-in.
   Sofia explains that it will handle authorization and token refresh while
...
5. “After Sofia restarts, the local gateway is registered again and the
...
6. “When I disconnect, Sofia deletes its credential and removes the local
