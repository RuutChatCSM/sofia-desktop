...
The org-level Google Workspace connection in Sofia Cloud previously
...
1. As the workspace admin, I open Connections in the Sofia Cloud dashboard and tap Google Workspace. I now see every permission my team's AI could use across Calendar, Gmail, and Drive — with the desktop app's defaults already checked.
...
5. After approving, their card flips to Connected and the connection records those granted permissions — ready for Gmail, Calendar, and Drive work through Sofia.
