...
This is an internal proof: the protagonist is the stored connection credential inside Sofia Cloud's MCP client, driven through real provider scenarios at the terminal.
