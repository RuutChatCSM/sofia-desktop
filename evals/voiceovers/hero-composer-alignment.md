...
Sofia now opens on the new-task screen, and that screen reuses the real chat
...
1. Sofia opens on the new-task screen: "What do you need done?", the real composer with its agent, model and effort controls, and the starter cards sitting underneath it.
