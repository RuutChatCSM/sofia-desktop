...
Cast is Alex Chen, owner of Acme Robotics, on a fresh Sofia desktop
connected to Sofia Cloud. His org ships a custom LLM provider (Acme Azure
...
2. He signs in to Sofia Cloud with a pasted sign-in code and lands on the organization picker — he chooses Acme Robotics, the org whose provider used to trigger the loop.
