...
1. I open Connections and choose Microsoft 365. Sofia guides me through Entra setup and shows Calendar, Outlook, OneDrive, and Teams groups with exact Graph scopes. Only the existing read capabilities start selected.
...
3. I ask Sofia to summarize my three latest emails. It returns concise summaries with links to the original Outlook messages, without importing my entire mailbox.

4. Next I ask for my upcoming meetings and the Q3 plan in OneDrive. Sofia shows the next calendar events, finds the file, and returns its source link and content.
...
6. I disconnect Microsoft 365 and ask the same question again. Sofia reports that my account needs to be connected instead of silently using another person's credentials.
