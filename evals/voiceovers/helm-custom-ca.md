...
1. Here is an existing Kubernetes Secret containing our private CA certificate. Sofia's Helm values reference it globally without embedding certificate material.
...
4. With strict certificate verification enabled, the migration completes and Sofia connects successfully to a MySQL endpoint signed by that private CA.
