...
1. From the landing page you get the normal Sofia app, and on first run it offers a calm choice — three option cards: use Sofia Cloud, join your organization with your link, or just get started locally.
...
4. Paste the link and it confirms your team and server, installs the version your organization supports, and launches Sofia straight into your team's sign-in — never a default.
