...
1. Alex runs Acme Robotics on Sofia, and inviting Maya is one line on the team page — type her email, pick a role, send.
...
4. The moment she joins, Sofia shows the one next step that matters: get the desktop app — everything it unlocks, a download button, and Open Sofia if it's already installed.
...
6. Back on the join page she clicks Open Sofia, and the desktop app signs itself in to Acme Robotics — no retyped credentials, her team's workspace right there.
...
8. Sofia is honest about where it runs: on the phone there's no dead-end download button — it tells Riley to grab the app at a computer, and offers to email the link instead.
