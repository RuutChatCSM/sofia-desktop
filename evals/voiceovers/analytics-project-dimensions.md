...
A team member connects their desktop app to the company's Sofia Cloud, names their new workspace's project once, and the organization's analytics learn to filter by it — no keys, no slugs, no extra setup.

1. The member pastes their cloud sign-in code into Settings and the desktop app connects to the organization's Sofia Cloud.
