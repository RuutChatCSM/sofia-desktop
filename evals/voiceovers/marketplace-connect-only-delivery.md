# marketplace-connect-only-delivery — org marketplace plugins arrive through Sofia Connect, with nothing to install
...
1. My organization publishes a plugin to its marketplace, and on my desktop it simply appears in Sofia Connect — already active, running in the cloud, with nothing to install.
