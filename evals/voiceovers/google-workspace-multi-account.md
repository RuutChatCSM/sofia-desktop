...
Cast reuses the Google Workspace demo — Alex (org admin, Sofia Cloud) and
...
5. Back in Sofia both connectors read Connected, each showing the real email address behind it. Two sign-ins, both hers, each one revocable on its own.
