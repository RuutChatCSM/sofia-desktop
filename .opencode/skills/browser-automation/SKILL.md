...
- Attach OpenCode browser tools to the Sofia Electron app during local development.
...
```sh
nohup pnpm dev > /var/folders/d9/xqhkvsp94rg0n0n523snqztm0000gn/T/opencode/sofia-dev.log 2>&1 &
```
