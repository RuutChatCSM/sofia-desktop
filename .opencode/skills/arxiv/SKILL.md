---
name: arxiv
description: "Use this skill whenever the user wants to find, read, cite, track, download, or analyze academic papers on arXiv. That includes searching papers by topic, author, category, or arXiv ID; fetching abstracts or full metadata; generating BibTeX citations; downloading PDFs; listing the latest submissions in a field (e.g. cs.AI daily digest); checking a paper citation impact; finding who cites a paper, what it references, or related-paper recommendations. Trigger on mentions of arXiv, an arXiv ID (e.g. 2601.02780 or hep-th/0601001), an arxiv.org URL, paper search, literature review, find papers about X, cite this paper, or what is new in cs.LG."
license: MIT
---
