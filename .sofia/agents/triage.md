...
**Only** add if it's specifically about the Desktop application or `engine web` view. **Do not** add for terminal, TUI, or general engine issues.
...
**Only** add if the issue mentions "zen" or "engine zen" or "engine black".

If the issue doesn't have "zen" or "engine black" in it then don't add zen label
