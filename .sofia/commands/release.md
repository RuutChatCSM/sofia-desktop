---
description: Run the Sofia release flow
---

You are running the Sofia release flow in this repo.

Arguments: `$ARGUMENTS`
- If empty, default to a patch release.
- If set to `minor` or `major`, use that bump type.

Load and follow `.sofia/skills/release/SKILL.md`; `docs/RELEASING.md` is the
...
6. Verify the public release assets resolve, `npm view sofia-server version`
