---
name: super-research
description: "Autonomous research skill for high-volume work that produces honest, comparable, auditable evidence. Eight modes: experiment loop, topic survey, quantitative analysis, benchmark comparison, root-cause investigation, ablation study, paper reproduction, and paper writing with citation audit. Trigger on optimize, tune, run experiments, survey, literature review, analyze dataset, compare options, root cause, ablate, reproduce paper, write paper, citation check."
---
