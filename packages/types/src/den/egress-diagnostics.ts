...
export const EGRESS_DIAGNOSTIC_RUN_HEADER = "x-sofia-diagnostic-run-id"
export const EGRESS_DIAGNOSTIC_STEP_HEADER = "x-sofia-diagnostic-step"
export const EGRESS_DIAGNOSTIC_SIGNATURE_HEADER = "x-sofia-diagnostic-signature"
export const EGRESS_DIAGNOSTIC_ID_HEADER = "x-sofia-diagnostic-id"
