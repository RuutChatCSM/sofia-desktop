...
export const workflowVersionSchema = z.object({
  id: idSchema,
  // Authoring source and example input are Sofia management data, not MCP
 ...
 * Sofia surfaces can validate the same result without understanding the UI.
 */
...
export const generatedArtifactViewRevisionSchema = z.object({
  ...
  resourceUri: z.string().startsWith("ui://sofia/artifacts/"),
