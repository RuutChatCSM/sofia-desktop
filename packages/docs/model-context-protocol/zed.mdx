---
title: "Sofia MCP for Zed"
sidebarTitle: "Zed"
description: "Zed MCP setup for Sofia Connect through mcp-remote and OAuth access to your org's shared capabilities."
---

The Sofia MCP server ([Sofia Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Zed to use the Sofia capabilities your organization has made
