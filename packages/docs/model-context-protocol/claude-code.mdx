---
title: "Sofia MCP for Claude Code"
sidebarTitle: "Claude Code"
description: "Claude Code MCP setup for Sofia Connect, with OAuth access to your org's Gmail, Calendar, Drive, shared MCP connections, skills, and Cloud resources."
---

The Sofia MCP server ([Sofia Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Claude Code to use the Sofia capabilities your organization has made
...
3. Select `sofia`, then follow the browser sign-in and choose your
   organization.

## Switch organizations

Run `/mcp` inside Claude Code, select `sofia`, then clear or
