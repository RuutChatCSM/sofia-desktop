---
title: "Sofia MCP for Claude Desktop"
sidebarTitle: "Claude Desktop"
description: "Claude Desktop MCP setup for Sofia Connect, using custom connectors or mcp-remote to reach your org's shared capabilities."
---

The Sofia MCP server ([Sofia Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Claude Desktop to use the Sofia capabilities your organization has
...
3. Name it `Sofia` and set the URL to:
...
Sofia accepts. Restart Claude Desktop after editing the config.
