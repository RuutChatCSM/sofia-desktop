...
- `Built-in Extensions`: allow or block Sofia-provided built-in extensions, including browser, image, and local-provider extensions.
- `Welcome Page`: show or hide the getting-started page for new users.

## Configure a policy

1. Open [sofia-app.ruut.chat](https://sofia-app.ruut.chat/) and choose your organization.
