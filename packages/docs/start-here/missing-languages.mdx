...
description: "See which Sofia languages ship today and help us improve them."
---

Sofia already ships with a growing set of languages, and we want to keep expanding that list.
...
<Frame>
  <iframe
    ...
    title="Sofia missing languages overview"
...
If you want to improve an existing translation, start in [`apps/app/src/i18n/locales`](https://github.com/RuutChatCSM/sofia-desktop/tree/dev/apps/app/src/i18n/locales).
...
If you want to add a new language to Sofia, the basic file changes are:
...
If you want to follow broader localization work, language requests, or upcoming improvements, check the [i18n roadmap](https://github.com/RuutChatCSM/sofia-desktop/issues/1385).
