...
description: "Understand when Sofia model usage starts and how to control it."
---

Sofia uses model tokens when a member actually runs work. Setup actions do not consume tokens by themselves.
...
5. Prompt cards do not cost anything while they sit in a policy, no matter how many an admin configures. Installing skills or publishing plugins through Collections also costs nothing until a member runs a task that uses them.
