---
title: "Deploy on AWS"
description: "Run Sofia on Amazon EKS with Amazon RDS for MySQL."
---
...
The Sofia chart manages Deployments, Services, ConfigMaps, Secret references, probes, and the database migration Job.
...
For exact CLI commands, values, DNS/TLS choices, migration troubleshooting, verification, and cleanup, follow the [AWS EKS operator runbook](https://github.com/RuutChatCSM/sofia-desktop/blob/dev/docs/aws-eks-helm.md).
