...
function DownloadLink({
  ...
  return (
    <a
      ...
      data-testid={testId ?? "download-sofia-link"}
      data-download-sofia-link="true"
...
export function DownloadSofiaCard({
  installers,
  releaseTag,
}: {
  ...
  return (
    <section
      data-testid="download-sofia-card"
      data-detected-os={detected?.os}
      data-detected-arch={detected ? detected.arch ?? "unknown" : undefined}
    ...
    >
      <div className="bg-gradient-to-b from-[#FAFBFE] to-white px-6 py-5">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-[16px] font-semibold text-[#07192C]">Download Sofia</span>
          {tag ? (
