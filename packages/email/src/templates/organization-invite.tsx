...
const LOGO_URL = "https://sofia.ruut.chat/email/sofia-mark.png"
...
export function OrganizationInviteEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>{invitedByName} invited you to join {organizationName} on Sofia</Preview>
      <Body style={styles.body}>
        <Container style={styles.frame}>
          <Section style={styles.brand}>
            <Img src={LOGO_URL} width="31" height="24" alt="Sofia" style={styles.brandLogo} />
            <span style={styles.brandName}>Sofia</span>
          </Section>
          <Section style={styles.card}>
            <Text style={styles.eyebrow}>Invitation</Text>
            <Heading style={styles.heading}>Join {organizationName} on Sofia</Heading>
          ...
          <Text style={styles.footer}>
            You received this email because someone invited you to an Sofia workspace.
            <br />
