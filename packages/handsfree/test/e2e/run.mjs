...
const HELPER_APP = process.env.SOFIA_COMPUTER_USE_HELPER
  ?? join(repoRoot, "apps/desktop/resources/helpers/Sofia App Computer Use.app");
...
try { execSync(`pkill -f 'Sofia App Computer Use.app'`); } catch {}
