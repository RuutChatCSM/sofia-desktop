...
/**
 * @param {Partial<import("@sofia/types/desktop-ipc").DesktopBootstrapConfig>} config
 ...
 * @param {{
 *   persistBootstrap: (
 *     config: Partial<import("@sofia/types/desktop-ipc").DesktopBootstrapConfig>
 *   ) => Promise<import("@sofia/types/desktop-ipc").DesktopBootstrapConfig>,
