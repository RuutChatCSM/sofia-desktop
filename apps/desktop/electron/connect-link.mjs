...
const CONNECT_LINK_AUDIENCE = "sofia-desktop-connect";
...
/**
 * @param {import("@sofia/types/connect-link").ConnectLinkClaims} claims
 * @returns {string | null}
 */
 ...
 * @returns {import("@sofia/types/connect-link").ConnectLinkClaims | null}
 */
...
/**
 * Extracts the signed token from a connect deep link. Accepts the sofia
 * and sofia-dev schemes and both authority forms (sofia://connect and
 * sofia:///connect).
 *
 * @param {string} rawUrl
 * @returns {string | null}
...
export function extractConnectLinkToken(rawUrl) {
  ...
  if (parsed.protocol !== "sofia:" && parsed.protocol !== "sofia-dev:") return null;
 ...
 *   allowInsecureLoopback?: boolean,
 * }} options
 * @returns {Promise<import("@sofia/types/connect-link").ConnectLinkVerifyResult>}
 */
