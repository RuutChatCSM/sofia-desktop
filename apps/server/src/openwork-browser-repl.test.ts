...
function startRepl() {
  const child = spawn("node", [join(import.meta.dir, "openwork-browser-repl.mjs")], {
    env: { ...process.env, OPENWORK_BROWSER_CDP_URL: "http://127.0.0.1:1" },
...
describe("openwork browser Node REPL", () => {
