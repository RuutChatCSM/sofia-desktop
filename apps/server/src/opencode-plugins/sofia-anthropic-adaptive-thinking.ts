/**
 * Sofia App Anthropic Adaptive Thinking Plugin
 *
 ...
 *
 * The bundled Sofia engine sidecar only emits the adaptive shape for model ids it
...
export const SofiaAnthropicAdaptiveThinking = async () => ({
  "chat.params": async (
