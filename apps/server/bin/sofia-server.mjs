...
const binaryName = process.platform === "win32" ? "sofia-server.exe" : "sofia-server";
...
console.error(
  `Unable to find an Sofia server entrypoint in ${basename(packageRoot)}. Build the package or run it from a source checkout with Bun available.`,
);
process.exit(1);
