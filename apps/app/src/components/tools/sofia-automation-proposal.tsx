...
import { automationProposalSchema, AUTOMATION_FREE_MODEL, type AutomationProposal } from "@sofia/types/automations"
...
/**
 * Reads an `automation.propose` affordance result out of an sofia_execute
...
export function isAutomationProposalToolPart(part: DynamicToolUIPart): boolean {
  return part.toolName === "sofia_execute"
    && part.state === "output-available"
    && parseAutomationProposal(part.output) !== null
}

export function SofiaAutomationProposalTool({ part }: { part: DynamicToolUIPart }) {
  ...
  return (
    <div
      ...
      data-sofia-automation-proposal
