...
export type SofiaSessionCreateResult = {
  ok: boolean
...
export function parseSofiaSessionCreateResult(output: unknown): SofiaSessionCreateResult | null {
...
export function SofiaSessionCreateTool({ part }: { part: DynamicToolUIPart }) {
  ...
  const result = parseSofiaSessionCreateResult(part.output)
  if (!result) {
  ...
  return (
    <div
      ...
      data-sofia-session-create-card
