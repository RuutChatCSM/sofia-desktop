 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, Sofia) are NOT translated
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "Sofia server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "Sofia server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "connect.diagnostics_agent_description": "Redacted evidence from the server-computed Sofia agent configuration intent. Effective engine state was not observed.",
  "connect.diagnostics_agent_description_effective": "Redacted evidence from the effective engine-resolved Sofia agent and its context markers.",
  ...
  "connect.diagnostics_check_agent_resolution": "Sofia agent configuration intent",
  "connect.diagnostics_check_agent_resolution_effective": "Effective Sofia agent resolution",
  ...
  "connect.diagnostics_mcp_description_effective": "The engine's merged configuration and Sofia-managed dynamic injection intent are shown separately. Runtime rows include exact registration outcomes; this is not a complete live tool-registry snapshot.",
  ...
  "connect.diagnostics_owner_sofia_client": "Sofia client",
  "connect.diagnostics_owner_sofia_server": "Sofia server",
  "connect.diagnostics_owner_sofia_support": "Sofia support",
  ...
  "connect.diagnostics_configured_agent": "Configured Sofia agent",
  "connect.diagnostics_effective_agent": "Effective Sofia agent",
  "connect.diagnostics_agent_state": "Sofia agent state",
  ...
  "connect.diagnostics_unavailable_direct_engine": "For privacy, agent diagnostics are unavailable for direct remote Sofia workspaces. Use a remote Sofia workspace to run this report.",
  ...
  "connect.header_description": "Use team-approved cloud connections shared from Sofia Den.",
  ...
  "connect.pitch_title": "Connect is the new way Sofia lets you share workflows with your team.",
  ...
  "connect.state_unavailable_action": "Restart Sofia. If this continues, run diagnostics.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected Sofia servers.",
  ...
  "config.server_needed_hint": "Sofia server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to a Sofia server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "Sofia server",
  ...
  "config.server_sharing_title": "Sofia server sharing",
  "config.server_url_hint": "Use the URL shared by your Sofia server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "Sofia server URL",
  "config.server_url_label": "Sofia Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable Sofia server workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "Sofia server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "Sofia server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "Sofia server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable Sofia server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted Sofia worker using a URL and access token.",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted Sofia worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save a Sofia server as a workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the Sofia server details for this workspace.",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted Sofia worker.",
  ...
  "connect.error_unknown_kid": "This link was signed with a newer key than this app knows. Update Sofia and try again.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and Sofia will reconnect here automatically.",
  ...
  "den.cloud_provider_needs_server": "Needs Sofia server",
  ...
  "den.error_paste_valid_code": "Paste a valid Sofia sign-in link or one-time sign-in code.",
  ...
  "den.signin_link_hint": "If your browser doesn't bounce back into Sofia automatically, paste the sign-in link or one-time code from Organization cloud here.",
  ...
  "den.status_browser_signin": "Finish signing in in your browser to connect Sofia.",
  "den.status_browser_signin_paste": "Sign in in your browser, copy the Sofia link, then paste it below.",
  "den.status_browser_signup": "Finish account creation in your browser to connect Sofia.",
  "den.status_browser_signup_paste": "Create your account in the browser, copy the Sofia link, then paste it below.",
  ...
  "den.status_server_config_cleared": "Cleared the desktop server configuration. Sofia is using the default Cloud control plane.",
  ...
  "extensions.add_plugin_collection_hint": "Publishing puts the plugin in the collection so members find it in the Sofia.",
  ...
  "extensions.marketplace_description": "Browse Sofia built-ins and organization marketplace extensions. Built-ins stay local; organization marketplace extensions run through Organization cloud, while GitHub and Claude plugin imports live in local Library.",
  ...
  "mcp.toggle_requires_server": "Connect to a Sofia server to enable or disable MCPs.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so Sofia can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, Sofia needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, Sofia needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize Sofia",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from Sofia.",
  ...
  "mcp.managed_oauth_unavailable": "Secure storage is unavailable on this device, so Sofia-managed sign-ins are paused.",
  ...
  "mcp.oauth_secret_warning": "Sofia encrypts these credentials in local app data. They are not written to your workspace or engine configuration. Keep client secrets out of chats and source control.",
  ...
  "mcp.quick_connect_sofia_ui_desc": "Let agents see and drive the Sofia. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_sofia_ui_title": "Sofia UI Control",
  ...
  "notifications.reconnect_failed": "Couldn't reconnect to the Sofia server",
  ...
  "welcome.title": "Welcome to Sofia",
  ...
  "welcome.organization_server_dialog_desc": "Paste the server URL your IT team shared. Sofia will use it before sign-in and cloud features.",
  "welcome.organization_server_dialog_title": "Connect to your organization's server",
  "welcome.organization_server_error": "Enter a valid http:// or https:// Sofia server URL.",
  "welcome.organization_server_link": "Using Sofia on-premises?",
  ...
  "welcome.use_cloud_subtitle": "Sign in for hosted Sofia and team features",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. Sofia will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and Sofia can pick them up.",
  ...
  "join_org.confirm_invite_body": "Only continue if you trust {host}. Sofia will use it as your organization server and open the invite in your browser.",
  ...
  "join_org.error_invalid": "That does not look like a Sofia invite link, install link, server URL, or sign-in code.",
  "join_org.error_invalid_config": "This link opened, but it did not contain a valid Sofia organization setup. Ask your admin for a fresh one.",
  "join_org.error_network": "Sofia could not reach that organization server. Check your connection or VPN, then try again.",
  ...
  "join_org.invite_opened": "Your invite opened in the browser — finish joining there. Sofia now points at {host} and is ready when you come back.",
  ...
  "session.share_local_host_not_ready": "Local Sofia host is not ready yet.",
  "session.share_missing_host_url": "Missing Sofia host URL.",
  "session.share_missing_token": "Missing Sofia token.",
  ...
  "session.share_sofia_workers_only": "Share service links are available for Sofia workers.",
  ...
  "settings.privacy_section_desc": "Control what Sofia shares to improve the product.",
  ...
  "settings.capabilities_title": "Sofia server capabilities",
  ...
  "settings.custom_binary_hint": "Use this to point Sofia at a local engine build",
  ...
  "settings.debug_sofia_server_version": "Sofia server: {version}",
  ...
  "settings.runtime_config_one_writer_rule": "Sofia writes only the managed runtime config file; user engine config stays user-owned.",
  ...
  "settings.runtime_config_no_removed_keys": "No Sofia-managed keys removed.",
  ...
  "settings.desktop_notifications.mode_desc": "Choose which Sofia events can appear as native operating system notifications.",
  ...
  "settings.enable_exa_desc": "Applies the next time the engine is started by Sofia. Off by default.",
  ...
  "settings.feedback_title": "Help shape Sofia",
  ...
  "settings.nuke_confirmation_hint": "Sofia will revoke your cloud session best-effort, wipe local state, then relaunch.",
  ...
  "settings.nuke_dialog_desc": "This removes local Sofia, engine, browser, token, runtime, cache, and legacy runtime state on this device.",
  ...
  "settings.nuke_survives_app": "The installed Sofia and protocol registration stay installed.",
  "settings.nuke_survives_bootstrap": "Bootstrap / organization server: {path}",
  "settings.nuke_survives_title": "Will survive",
  "settings.nuke_survives_workspaces": "Workspace folders and your files inside them are not touched, but each workspace's Sofia state is removed.",
  "settings.off": "Off",
  "settings.on": "On",
  "settings.open_deeplink_action": "Opening...",
  "settings.open_deeplink_button": "Hide",
  "settings.open_deeplink_desc": "Paste a Sofia deeplink or share URL to open it.",
  ...
  "settings.organization_server_desc": "Point Sofia at the server your organization hosts. This is available without developer mode.",
  "settings.organization_server_title": "Organization server",
  "settings.organization_server_url_hint": "Paste your organization's Sofia server URL. Saving signs you out so Sofia can re-hydrate against that server.",
  ...
  "settings.sofia_engine_sidecar_desc": "Local engine process managed by Sofia.",
  ...
  "settings.codex_engine_sidecar_desc": "Multi-model Sofia engine managed by Sofia.",
  ...
  "settings.codex_install_succeeded": "Sofia engine installed. Restart Sofia to use it.",
  ...
  "settings.sofia_config_sidecar_desc": "Local Sofia server (Bun) that hosts approvals, audit, and engine lifecycle.",
  "settings.sofia_diagnostics_title": "Sofia server diagnostics",
  "settings.sofia_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.sofia_server_label": "Sofia server",
  ...
  "settings.quit_hint": "Sofia quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect Sofia server.",
  "settings.reconnected": "Reconnected to Sofia server.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears Sofia cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears Sofia cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. Sofia will restart.",
  ...
  "settings.reset_onboarding_description": "Clears Sofia preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears Sofia local preferences and workspace onboarding markers.",
  ...
  "settings.reset_sofia_title": "Reset Sofia state",
  ...
  "settings.restart_blocked_message": "The update is ready, but Sofia will wait until your active tasks finish before restarting. You can also stop them manually.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_engine": "Restart engine",
  "settings.restart_sofia_server": "Restart Sofia server",
  ...
  "settings.services_section_desc": "Local services that power this Sofia session. Each service has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting Sofia.",
  ...
  "settings.server_endpoints_desc": "Read-only view of the URLs Sofia will use after local overrides and bootstrap files are applied.",
  ...
  "settings.runtime_desc": "Status for your local engine and Sofia server.",
  ...
  "settings.tab_description_appearance": "Adjust how Sofia looks across desktop, system theme, and app frame.",
  ...
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected Sofia workspace plus its runtime connection.",
  ...
  "settings.environment.override_hint": "Environment variables set before Sofia starts take precedence over values saved here.",
  ...
  "settings.environment.apply_confirm_body": "Sofia will restart local agents so they can use the latest environment. Running local tasks may stop.",
  "settings.environment.apply_no_local_workspace": "Sofia is not connected to a local workspace.",
  ...
  "settings.environment.apply_refresh_failed": "Changes are active, but Sofia status did not refresh. Reopen the app if it looks stale.",
  ...
  "settings.environment.validation_reserved": "Reserved environment names are managed by Sofia.",
  ...
  "memory.sign_in_hint": "Sign in to your Sofia account to view your memory bank.",
  ...
  "settings.update_blocked_org": "Sofia {version} is available, but your organization has not approved it yet. Ask an organization administrator to enable this version.",
  ...
  "settings.update_restart_active_tasks": "You have active tasks. Installing the update restarts Sofia and will interrupt them.",
  "settings.update_restart_confirm_title": "Restart with active tasks?",
  "settings.update_restart_confirm_message": "Installing the update restarts Sofia now and interrupts your active tasks. You may need to resume them after the update.",
  "settings.update_uptodate": "You're up to date",
  "settings.updates": "Updates",
  "settings.updates_desc": "Keep Sofia up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach a Sofia host, then choose it from the list to import this skill.",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected Sofia server.",
  ...
  "status.limited_hint": "Reconnect to restore full Sofia features",
  ...
  "status.sofia_ready": "Sofia Ready",
  ...
  "system.reload_body_default": "Sofia detected changes that require reloading the engine.",
  "system.reload_body_mcp": "The engine loads MCP servers at startup. Reload it to activate the new connection.",
  "system.reload_body_mixed": "Sofia detected engine configuration changes. Reload the engine to apply them.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "Sofia can't load tasks from this worker until the connection is fixed.",
