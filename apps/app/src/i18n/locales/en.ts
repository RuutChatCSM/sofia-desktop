...
export default {
  ...
  "den.signin_link_hint": "If your browser doesn't bounce back into Sofia App automatically, paste the sign-in link or one-time code from OpenWork Cloud here.",
  ...
  "extensions.marketplace_description": "Browse Sofia App built-ins and organization marketplace extensions. Built-ins stay local; organization marketplace extensions run through OpenWork Cloud, while GitHub and Claude plugin imports live in local Library.",
  ...
  "settings.codex_install_succeeded": "Codex engine installed. Restart Sofia App to use it.",
  "settings.codex_install_failed": "Codex install failed: {detail}",
  "settings.engine_picker_title": "Engine",
  "settings.engine_picker_desc": "Choose which agent engine new sessions use. Codex is the default.",
  "settings.codex_engine_label": "Sofia",
  "settings.codex_engine_desc": "Codex-based, multi-model agent runtime.",
  "settings.opencode_engine_switch_desc": "Switch back to the OpenCode runtime.",
  "settings.codex_engine_unavailable": "Codex is not available on this device.",
  "settings.codex_engine_status_line": "Codex: {value}",
