 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, Sofia App) are NOT translated
 */
...
export default {
  ...
  "connect.diagnostics_owner_openwork_client": "Sofia App client",
  "connect.diagnostics_owner_openwork_server": "Sofia App server",
  "connect.diagnostics_owner_openwork_support": "Sofia App support",
  ...
  "connect.diagnostics_unavailable_direct_opencode": "For privacy, agent diagnostics are unavailable for direct remote OpenCode workspaces. Use a remote Sofia App workspace to run this report.",
  ...
  "extensions.add_plugin_collection_hint": "Publishing puts the plugin in the collection so members find it in the Sofia App app.",
  ...
  "mcp.name_reserved_openwork_connect": "This name is reserved for Connections. Choose a different name for the workspace MCP.",
  ...
  "mcp.oauth_secret_warning": "Sofia App encrypts these credentials in local app data. They are not written to your workspace or OpenCode configuration. Keep client secrets out of chats and source control.",
  ...
  "mcp.quick_connect_openwork_cloud_title": "Organization cloud Control",
  "mcp.quick_connect_openwork_ui_desc": "Let agents see and drive the Sofia App app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_openwork_ui_title": "Sofia App UI Control",
  ...
  "join_org.openwork_cloud": "Organization cloud",
  ...
  "session.share_openwork_workers_only": "Share service links are available for Sofia App workers.",
  ...
  "settings.custom_binary_hint": "Use this to point Sofia App at a local OpenCode build",
  ...
  "settings.debug_openwork_server_version": "Sofia App server: {version}",
  ...
  "settings.runtime_config_one_writer_rule": "Sofia App writes only the managed runtime config file; user OpenCode config stays user-owned.",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by Sofia App. Off by default.",
  ...
  "settings.nuke_dialog_desc": "This removes local Sofia App, OpenCode, browser, token, runtime, cache, and legacy runtime state on this device.",
  ...
  "settings.nuke_survives_app": "The installed Sofia App app and protocol registration stay installed.",
  "settings.nuke_survives_bootstrap": "Bootstrap / organization server: {path}",
  "settings.nuke_survives_title": "Will survive",
  "settings.nuke_survives_workspaces": "Workspace folders and your files inside them are not touched, but each workspace's Sofia App state (.opencode/openwork) is removed.",
  "settings.off": "Off",
  "settings.on": "On",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by Sofia App.",
  ...
  "settings.opencode_engine_switch_desc": "Switch back to the OpenCode runtime.",
  ...
  "settings.openwork_config_sidecar_desc": "Local Sofia App server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  "settings.openwork_diagnostics_title": "Sofia App server diagnostics",
  "settings.openwork_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.openwork_server_label": "Sofia App server",
  ...
  "settings.reset_openwork_title": "Reset Sofia App + OpenCode state",
  ...
  "settings.restart_openwork_server": "Restart Sofia App server",
  ...
  "settings.environment.validation_reserved": "OPENWORK_ and OPENCODE_ names are managed by Sofia App/OpenCode.",
  ...
  "status.openwork_ready": "Sofia App Ready",
  ...
  "system.reload_body_default": "Sofia App detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "Sofia App detected OpenCode configuration changes. Reload the engine to apply them.",
