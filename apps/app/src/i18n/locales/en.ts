 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, Sofia App) are NOT translated
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "Sofia App server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "Sofia App server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "composer.connect_skill_prompt": "Use the \"{name}\" skill from the \"{marketplace}\" marketplace. Find it with sofia-cloud_search_capabilities, then call sofia-cloud_execute_capability with the exact capability name \"{capability}\", follow the returned skill content, and use it to ",
  ...
  "composer.queued_steer": "Steer",
  "composer.queued_more": "+{count} queued",
  "composer.queued_move_up": "Move up",
  "composer.queued_move_down": "Move down",
  "composer.queued_more_actions": "More actions",
  ...
  "connect.connected_to_cloud": "Connected to Organization cloud",
  "connect.connected_to_org": "Connected to {name}",
  "connect.diagnostics_action_label": "Recommended action",
  "connect.diagnostics_agent_description": "Redacted evidence from the server-computed Sofia App agent configuration intent. Effective engine state was not observed.",
  "connect.diagnostics_agent_description_effective": "Redacted evidence from the effective engine-resolved Sofia App agent and its context markers.",
  ...
  "connect.diagnostics_check_agent_resolution": "Sofia App agent configuration intent",
  "connect.diagnostics_check_agent_resolution_effective": "Effective Sofia App agent resolution",
  "connect.diagnostics_check_cloud_endpoint_differential": "Runtime probe vs engine verdict",
  "connect.diagnostics_check_cloud_endpoint_transport": "Organization cloud endpoint transport",
  "connect.diagnostics_check_cloud_tool_catalog": "Organization cloud tool catalog",
  ...
  "connect.diagnostics_global_cloud_mcp": "Global Organization cloud MCP",
  ...
  "connect.diagnostics_mcp_description_effective": "The engine's merged configuration and Sofia App-managed dynamic injection intent are shown separately. Runtime rows include exact registration outcomes; this is not a complete live tool-registry snapshot.",
  ...
  "connect.diagnostics_org_description": "These connections operate behind the single Organization cloud meta-MCP and are not injected as separate engine MCPs.",
  ...
  "connect.diagnostics_owner_sofia_engine": "Sofia engine",
  "connect.diagnostics_owner_sofia_client": "Sofia App client",
  "connect.diagnostics_owner_sofia_server": "Sofia App server",
  "connect.diagnostics_owner_sofia_support": "Sofia App support",
  ...
  "connect.diagnostics_configured_agent": "Configured Sofia App agent",
  "connect.diagnostics_effective_agent": "Effective Sofia App agent",
  "connect.diagnostics_agent_state": "Sofia App agent state",
  ...
  "connect.diagnostics_unavailable_direct_engine": "For privacy, agent diagnostics are unavailable for direct remote Sofia workspaces. Use a remote Sofia App workspace to run this report.",
  "connect.diagnostics_workspace_cloud_mcp": "Selected workspace Organization cloud MCP",
  ...
  "connect.header_description": "Use team-approved cloud connections shared from Sofia App Den.",
  ...
  "connect.pitch_title": "Connect is the new way Sofia App lets you share workflows with your team.",
  ...
  "connect.state_not_configured_action": "Sign in to Organization cloud to finish setup.",
  ...
  "connect.state_unavailable_action": "Restart Sofia App. If this continues, run diagnostics.",
  ...
  "config.engine_reload_desc": "Restart the Sofia engine for this workspace.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected Sofia App servers.",
  ...
  "config.server_needed_hint": "Sofia App server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to a Sofia App server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "Sofia App server",
  ...
  "config.server_sharing_title": "Sofia App server sharing",
  "config.server_url_hint": "Use the URL shared by your Sofia App server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "Sofia App server URL",
  "config.server_url_label": "Sofia App Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable Sofia App server workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "Sofia App server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "Sofia App server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "Sofia App server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable Sofia App server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted Sofia App worker using a URL and access token.",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted Sofia App worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save a Sofia App server as a workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the Sofia App server details for this workspace.",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted Sofia App worker.",
  ...
  "connect.error_unknown_kid": "This link was signed with a newer key than this app knows. Update Sofia App and try again.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and Sofia App will reconnect here automatically.",
  ...
  "den.cloud_provider_needs_server": "Needs Sofia App server",
  ...
  "den.cloud_section_desc": "Sign in and pick an organization to access Organization cloud.",
  "den.cloud_section_title": "Organization cloud",
  "den.cloud_sleep_hint": "Sign in to Organization cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_signed_in_desc": "You are signed in and ready to use Organization cloud.",
  "den.open_dashboard": "Open Den dashboard",
  "den.cloud_unavailable_body": "Local work remains available. Reconnecting automatically.",
  "den.cloud_unavailable_title": "Organization cloud is temporarily unavailable.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but Organization cloud did not return a session token.",
  "den.error_paste_valid_code": "Paste a valid Sofia App sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete Organization cloud sign-in.",
  ...
  "den.error_signout_failed": "Could not sign out of Organization cloud. Try again.",
  ...
  "den.signin_code_note": "Accepts an sofia://den-auth link or the raw one-time grant.",
  "den.signin_link_copied": "Copied",
  "den.signin_link_hint": "If your browser doesn't bounce back into Sofia App automatically, paste the sign-in link or one-time code from Organization cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "sofia://den-auth?... or pasted code",
  "den.signin_title": "Sign in to Organization cloud",
  "den.signing_in": "Finishing Organization cloud sign-in...",
  "den.signing_out": "Signing out...",
  "den.status_base_url_updated": "Updated the Cloud control plane URL. Sign in again to continue.",
  "den.status_browser_signin": "Finish signing in in your browser to connect Sofia App.",
  "den.status_browser_signin_paste": "Sign in in your browser, copy the Sofia App link, then paste it below.",
  "den.status_browser_signup": "Finish account creation in your browser to connect Sofia App.",
  "den.status_browser_signup_paste": "Create your account in the browser, copy the Sofia App link, then paste it below.",
  "den.status_cloud_signed_in_as": "Connected Organization cloud as {email}.",
  "den.status_cloud_signin_done": "Connected Organization cloud.",
  ...
  "den.status_signed_out": "Signed out and cleared your Organization cloud session on this device.",
  "den.status_server_config_cleared": "Cleared the desktop server configuration. Sofia App is using the default Cloud control plane.",
  ...
  "extensions.create_skill_hint": "Saved to your organization Library. Agents can load these instructions from Organization cloud.",
  ...
  "extensions.add_sign_in_required": "Sign in to Organization cloud to add items to Library.",
  ...
  "extensions.add_plugin_collection_hint": "Publishing puts the plugin in the collection so members find it in the Sofia App.",
  ...
  "extensions.add_unauthorized": "Your Organization cloud session expired. Sign in again, then create the skill.",
  ...
  "extensions.empty_connections": "{org} has not shared any connections with you yet. An admin adds them in the Organization cloud dashboard.",
  "extensions.empty_connections_signed_out": "Connections are shared by your organization. Sign in to Organization cloud from Account to see yours.",
  ...
  "extensions.marketplace_description": "Browse Sofia App built-ins and organization marketplace extensions. Built-ins stay local; organization marketplace extensions run through Organization cloud, while GitHub and Claude plugin imports live in local Library.",
  ...
  "extensions.surface_cloud": "Organization cloud",
  ...
  "extensions.plugins_engine_header": "Plugins (Sofia)",
  ...
  "mcp.toggle_requires_server": "Connect to a Sofia App server to enable or disable MCPs.",
  "mcp.action_reconnect": "Reconnect",
  "mcp.add_modal_subtitle": "Connect a custom MCP to this workspace. This setup stays separate from organization-managed services in Connections.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so Sofia App can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reauth_cli_hint": "Reconnect {server}, then authorize it again.",
  ...
  "mcp.auth.reload_notice": "For this to take effect, Sofia App needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, Sofia App needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize Sofia App",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from Sofia App.",
  ...
  "mcp.managed_oauth_unavailable": "Secure storage is unavailable on this device, so Sofia App-managed sign-ins are paused.",
  "mcp.name_required": "Enter a server name.",
  "mcp.name_reserved_sofia_connect": "This name is reserved for Connections. Choose a different name for the workspace MCP.",
  "mcp.no_apps_hint": "Connect one above to get started.",
  "mcp.no_apps_yet": "No apps connected yet",
  "mcp.oauth": "Sign in",
  "mcp.oauth_advanced_hint": "This desktop handles sign-in and token refresh, and encrypts the OAuth credentials in this device's protected app storage. This is separate from Connections and does not connect other devices.",
  ...
  "mcp.oauth_secret_warning": "Sofia App encrypts these credentials in local app data. They are not written to your workspace or engine configuration. Keep client secrets out of chats and source control.",
  ...
  "mcp.quick_connect_sofia_cloud_desc": "Manage your org, workers, skills, providers, and team config from chat. Try: \"List all workers in my org\" or \"Push this skill to the team.\"",
  "mcp.quick_connect_sofia_cloud_title": "Organization cloud Control",
  "mcp.quick_connect_sofia_ui_desc": "Let agents see and drive the Sofia App. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_sofia_ui_title": "Sofia App UI Control",
  ...
  "notifications.empty_hint": "Updates from Organization cloud and your workspaces will show up here.",
  "notifications.engine_reloaded": "Updates applied",
  "notifications.just_now": "Just now",
  "notifications.reconnect_failed": "Couldn't reconnect to the Sofia App server",
  ...
  "welcome.organization_server_dialog_desc": "Paste the server URL your IT team shared. Sofia App will use it before sign-in and cloud features.",
  "welcome.organization_server_dialog_title": "Connect to your organization's server",
  "welcome.organization_server_error": "Enter a valid http:// or https:// Sofia App server URL.",
  "welcome.organization_server_link": "Using Sofia App on-premises?",
  "welcome.organization_server_url_label": "Organization server URL",
  "welcome.organization_server_url_placeholder": "https://sofia.yourcompany.com",
  "welcome.team_signin": "Joining a team? Sign in",
  "welcome.use_cloud": "Use Organization cloud",
  "welcome.use_cloud_subtitle": "Sign in for hosted Sofia App and team features",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. Sofia App will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and Sofia App can pick them up.",
  ...
  "join_org.confirm_invite_body": "Only continue if you trust {host}. Sofia App will use it as your organization server and open the invite in your browser.",
  ...
  "join_org.error_invalid": "That does not look like a Sofia App invite link, install link, server URL, or sign-in code.",
  "join_org.error_invalid_config": "This link opened, but it did not contain a valid Sofia App organization setup. Ask your admin for a fresh one.",
  "join_org.error_network": "Sofia App could not reach that organization server. Check your connection or VPN, then try again.",
  "join_org.input_hint": "Accepted: invite links, install links, server URLs, “server token”, sofia://den-auth links, or a raw sign-in code.",
  ...
  "join_org.invite_opened": "Your invite opened in the browser — finish joining there. Sofia App now points at {host} and is ready when you come back.",
  "join_org.sofia_cloud": "Organization cloud",
  ...
  "plugins.add": "Add",
  "plugins.add_hint": "Add npm package names, e.g. /plugin-name",
  "plugins.add_label": "Add plugin",
  "plugins.added": "Added",
  "plugins.config": "Config",
  "plugins.config_label": "Config",
  "plugins.desc": "Manage plugins for your project or globally.",
  ...
  "session.cmd_reload_config_title": "Reload engine config",
  "session.cmd_reload_config_detail": "Re-read the engine config (providers, MCP servers, models) without restarting",
  ...
  "session.doom_loop_message": "Sofia detected repeated tool calls with identical input and is asking whether it should continue after repeated failures.",
  ...
  "session.permission_message": "Sofia is requesting permission to continue.",
  "session.permission_message_bash": "Review the command scope before allowing Sofia to continue.",
  "session.permission_message_edit": "Review the file and diff before allowing Sofia to make changes.",
  ...
  "session.share_local_host_not_ready": "Local Sofia App host is not ready yet.",
  "session.share_missing_host_url": "Missing Sofia App host URL.",
  "session.share_missing_token": "Missing Sofia App token.",
  ...
  "session.share_engine_base_url": "Sofia base URL",
  "session.share_sofia_workers_only": "Share service links are available for Sofia App workers.",
  ...
  "settings.api_keys_info": "API keys are stored locally by Sofia. Environment-backed providers must be changed in the worker environment and then reloaded.",
  ...
  "settings.privacy_section_desc": "Control what Sofia App shares to improve the product.",
  "settings.privacy_title": "Privacy",
  "settings.auto_compact_desc": "Controls engine compaction.auto for this workspace. Reload the engine after changing it.",
  ...
  "settings.capabilities_title": "Sofia App server capabilities",
  "settings.capabilities_unavailable": "Capabilities unavailable. Connect with a client token.",
  "settings.change": "Change",
  "settings.choose": "Choose",
  "settings.clear": "Clear",
  "settings.config_updated": "Configuration updated. Reload the engine if the change affects it.",
  ...
  "settings.custom_binary_hint": "Use this to point Sofia App at a local engine build",
  ...
  "settings.debug_engine_version": "Engine: {version}",
  "settings.debug_sofia_server_version": "Sofia App server: {version}",
  ...
  "settings.runtime_config_one_writer_rule": "Sofia App writes only the managed runtime config file; user engine config stays user-owned.",
  ...
  "settings.runtime_config_cleanup_no_files": "No legacy engine config files found.",
  "settings.runtime_config_removed_keys": "Removed: {keys}",
  "settings.runtime_config_no_removed_keys": "No Sofia App-managed keys removed.",
  "settings.runtime_config_backup_path": "Backup: {path}",
  "settings.runtime_config_no_backup": "No backup needed.",
  "settings.error": "Error",
  "settings.idle": "Idle",
  "settings.loading": "Loading",
  "settings.deeplink_hint": "Accepts sofia:// or sofia-dev:// links.",
  ...
  "settings.desktop_notifications.mode_desc": "Choose which Sofia App events can appear as native operating system notifications.",
  ...
  "settings.diag_engine_binary": "Engine binary: {binary}",
  ...
  "settings.enable_exa_desc": "Applies the next time the engine is started by Sofia App. Off by default.",
  ...
  "settings.engine_desc": "Choose how the engine runs locally.",
  ...
  "settings.feedback_title": "Help shape Sofia App",
  ...
  "settings.nuke_hint": "Use this only when you want to fully reset the desktop app and its engine runtime state.",
  ...
  "settings.nuke_confirmation_hint": "Sofia App will revoke your cloud session best-effort, wipe local state, then relaunch.",
  ...
  "settings.nuke_dialog_desc": "This removes local Sofia App, engine, browser, token, runtime, cache, and legacy runtime state on this device.",
  ...
  "settings.nuke_survives_app": "The installed Sofia App and protocol registration stay installed.",
  "settings.nuke_survives_bootstrap": "Bootstrap / organization server: {path}",
  "settings.nuke_survives_title": "Will survive",
  "settings.nuke_survives_workspaces": "Workspace folders and your files inside them are not touched, but each workspace's Sofia App state is removed.",
  "settings.off": "Off",
  "settings.on": "On",
  "settings.open_deeplink_action": "Opening...",
  "settings.open_deeplink_button": "Hide",
  "settings.open_deeplink_desc": "Paste a Sofia App deeplink or share URL to open it.",
  ...
  "settings.organization_server_default": "Using standard Organization cloud.",
  "settings.organization_server_desc": "Point Sofia App at the server your organization hosts. This is available without developer mode.",
  "settings.organization_server_title": "Organization server",
  "settings.organization_server_url_hint": "Paste your organization's Sofia App server URL. Saving signs you out so Sofia App can re-hydrate against that server.",
  "settings.organization_server_url_label": "Organization server URL",
  "settings.sofia_cache": "Local cache",
  "settings.sofia_cache_description": "Fix startup issues caused by stale local data.",
  "settings.sofia_engine_desc": "Local runtime for agents, tools, and model providers.",
  "settings.sofia_engine_label": "Sofia engine",
  "settings.sofia_engine_sidecar": "Sofia engine",
  "settings.sofia_engine_sidecar_desc": "Local engine process managed by Sofia App.",
  "settings.sofia_sdk_desc": "Browser → engine connection.",
  "settings.sofia_sdk_title": "Engine SDK link",
  "settings.codex_engine_sidecar": "Sofia engine",
  "settings.codex_engine_sidecar_desc": "Multi-model Sofia engine managed by Sofia App.",
  "settings.codex_engine_status": "Status: {value}",
  "settings.codex_engine_binary": "Binary: {binary}",
  "settings.codex_engine_version": "Version: {version}",
  "settings.available": "Available",
  "settings.not_available": "Not available",
  "settings.codex_install_action": "Install Sofia engine",
  "settings.codex_install_in_progress": "Installing…",
  "settings.codex_install_succeeded": "Sofia engine installed. Restart Sofia App to use it.",
  "settings.codex_install_failed": "Sofia install failed: {detail}",
  "settings.engine_picker_title": "Engine",
  "settings.engine_picker_desc": "Choose which agent engine new sessions use. Sofia is the default.",
  "settings.codex_engine_label": "Sofia",
  "settings.codex_engine_desc": "Multi-model agent runtime.",
  "settings.sofia_engine_switch_desc": "Switch back to the previous runtime.",
  "settings.codex_engine_unavailable": "Sofia is not available on this device.",
  "settings.codex_engine_status_line": "Sofia: {value}",
  "settings.sofia_section_label": "Sofia engine",
  "settings.opening": "Open deeplink",
  "settings.sofia_config_sidecar_desc": "Local Sofia App server (Bun) that hosts approvals, audit, and engine lifecycle.",
  "settings.sofia_diagnostics_title": "Sofia App server diagnostics",
  "settings.sofia_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.sofia_server_label": "Sofia App server",
  ...
  "settings.quit_hint": "Sofia App quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect Sofia App server.",
  "settings.reconnected": "Reconnected to Sofia App server.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears Sofia App cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears Sofia App cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. Sofia App will restart.",
  ...
  "settings.reset_onboarding_description": "Clears Sofia App preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears Sofia App local preferences and workspace onboarding markers.",
  "settings.reset_sofia_desc_dev": "With dev mode active, it only clears the isolated engine dev state inside the Sofia dev data directory.",
  "settings.reset_sofia_desc_prod": "With dev mode active, it only clears the isolated engine dev state inside the Sofia dev data directory.",
  "settings.reset_sofia_title": "Reset Sofia App state",
  ...
  "settings.restart_blocked_message": "The update is ready, but Sofia App will wait until your active tasks finish before restarting. You can also stop them manually.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_engine": "Restart engine",
  "settings.restart_sofia_server": "Restart Sofia App server",
  ...
  "settings.services_section_desc": "Local services that power this Sofia App session. Each service has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting Sofia App.",
  ...
  "settings.server_endpoints_desc": "Read-only view of the URLs Sofia App will use after local overrides and bootstrap files are applied.",
  "settings.server_endpoints_local_dev": "Local dev server",
  "settings.server_endpoints_mismatch": "Doesn't match API endpoint",
  "settings.server_endpoints_not_configured": "No sofia-cloud MCP entry configured",
  ...
  "settings.runtime_desc": "Status for your local engine and Sofia App server.",
  ...
  "settings.tab_connect": "Connections",
  ...
  "settings.tab_description_appearance": "Adjust how Sofia App looks across desktop, system theme, and app frame.",
  ...
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected Sofia App workspace plus its runtime connection.",
  ...
  "settings.environment.footer_hint": "Reserved environment namespaces are managed for app/runtime wiring. Configure engine runtime settings from your shell.",
  "settings.environment.override_hint": "Environment variables set before Sofia App starts take precedence over values saved here.",
  ...
  "settings.environment.apply_confirm_body": "Sofia App will restart local agents so they can use the latest environment. Running local tasks may stop.",
  "settings.environment.apply_no_local_workspace": "Sofia App is not connected to a local workspace.",
  ...
  "settings.environment.apply_refresh_failed": "Changes are active, but Sofia App status did not refresh. Reopen the app if it looks stale.",
  ...
  "settings.environment.validation_reserved": "Reserved environment names are managed by Sofia App.",
  ...
  "memory.sign_in_hint": "Sign in to your Sofia App account to view your memory bank.",
  ...
  "settings.update_blocked_org": "Sofia App {version} is available, but your organization has not approved it yet. Ask an organization administrator to enable this version.",
  ...
  "settings.update_restart_active_tasks": "You have active tasks. Installing the update restarts Sofia App and will interrupt them.",
  "settings.update_restart_confirm_title": "Restart with active tasks?",
  "settings.update_restart_confirm_message": "Installing the update restarts Sofia App now and interrupts your active tasks. You may need to resume them after the update.",
  "settings.update_uptodate": "You're up to date",
  "settings.updates": "Updates",
  "settings.updates_desc": "Keep Sofia App up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach a Sofia App host, then choose it from the list to import this skill.",
  ...
  "skills.failed_load_engine": "Failed to load engine.json",
  "skills.failed_parse_engine": "Failed to parse engine.json",
  "skills.failed_to_load": "Failed to load skills",
  "skills.failed_update_engine": "Failed to update engine.json",
  "skills.filter_all": "All",
  "skills.filter_installed": "Installed",
  "skills.host_mode_only": "Local workspace only",
  "skills.host_only_error": "Skill management requires a local workspace or connected Sofia App server.",
  ...
  "skills.no_engine_found": "No engine.json found yet. Add a plugin to create one.",
  "skills.no_engine_workspace": "No engine.json in this workspace yet.",
  "skills.no_skills": "No skills detected in `.sofia/skills`, `.claude/skills`, or `~/.agents/skills`.",
  ...
  "skills.share_option_team_desc": "Add this skill to your active Organization cloud organization.",
  ...
  "skills.share_team_permissions_intro": "Upload this skill to your active Organization cloud organization and decide who can see it.",
  ...
  "skills.share_team_sign_in_hint": "Organization cloud opens in your browser. Return here after signing in.",
  ...
  "status.limited_hint": "Reconnect to restore full Sofia App features",
  ...
  "status.sofia_ready": "Sofia App Ready",
  ...
  "status.reloading_config": "Reloading engine config",
  "status.running": "Running",
  "status.send_feedback": "Send feedback",
  "status.settings": "Settings",
  "system.reload_body_agents": "The engine loads agents at startup. Reload it to make updated agents available.",
  "system.reload_body_commands": "The engine loads commands at startup. Reload it to make updated commands available.",
  "system.reload_body_config": "The engine reads its config at startup. Reload it to apply configuration changes.",
  "system.reload_body_default": "Sofia App detected changes that require reloading the engine.",
  "system.reload_body_mcp": "The engine loads MCP servers at startup. Reload it to activate the new connection.",
  "system.reload_body_mixed": "Sofia App detected engine configuration changes. Reload the engine to apply them.",
  "system.reload_body_plugins": "The engine loads plugins at startup. Reload it to apply config changes.",
  "system.reload_body_skills": "The engine can cache skill discovery/state. Reload it to make newly installed skills available.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "Sofia App can't load tasks from this worker until the connection is fixed.",
