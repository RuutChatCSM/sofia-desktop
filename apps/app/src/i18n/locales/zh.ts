/**
 * 中文（简体）翻译
 * 产品名称保留英文：OpenCode、OpenPackage、Sofia App
...
export default {
  ...
  "session.share_openwork_workers_only": "分享服务链接仅适用于Sofia App工作区。",
  ...
  "settings.custom_binary_hint": "用于将Sofia App指向本地的OpenCode构建",
  ...
  "settings.debug_openwork_server_version": "Sofia App服务器：{version}",
  ...
  "settings.enable_exa_desc": "在Sofia App启动OpenCode时生效。",
  ...
  "settings.environment.validation_reserved": "OPENWORK_ 和 OPENCODE_ 名称由 Sofia App/OpenCode 管理。",
  ...
  "settings.openwork_diagnostics_title": "Sofia App服务器诊断",
  "settings.openwork_server_desc": "用于应用同步、工作者和远程连接的会话控制平面。",
  "settings.openwork_server_label": "Sofia App服务器",
  ...
  "settings.reset_openwork_title": "重置Sofia App + OpenCode状态",
  ...
  "status.openwork_ready": "Sofia App就绪",
  ...
  "system.reload_body_default": "Sofia App检测到需要重新加载OpenCode实例的变更。",
  "system.reload_body_mcp": "OpenCode在启动时加载MCP服务器。重新加载引擎以激活新连接。",
  "system.reload_body_mixed": "Sofia App检测到OpenCode配置变更。重新加载引擎以应用。",
