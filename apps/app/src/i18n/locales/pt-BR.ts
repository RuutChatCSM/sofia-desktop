 ...
 * Termos profissionais (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, Sofia App) NÃO são traduzidos
 */
...
export default {
  ...
  "session.share_openwork_workers_only": "Links de compartilhamento estão disponíveis para workers Sofia App.",
  ...
  "settings.custom_binary_hint": "Use para apontar o Sofia App para um build local do OpenCode",
  ...
  "settings.enable_exa_desc": "Aplica-se quando o Sofia App inicia o OpenCode.",
  ...
  "settings.openwork_diagnostics_title": "Diagnósticos do servidor Sofia App",
  ...
  "settings.reset_openwork_title": "Redefinir estado do Sofia App + OpenCode",
  ...
  "status.openwork_ready": "Sofia App Pronto",
  ...
  "system.reload_body_default": "O Sofia App detectou mudanças que exigem recarregar a instância do OpenCode.",
  "system.reload_body_mcp": "O OpenCode carrega servidores MCP na inicialização. Recarregue o engine para ativar a nova conexão.",
  "system.reload_body_mixed": "O Sofia App detectou mudanças na configuração do OpenCode. Recarregue o engine para aplicá-las.",
