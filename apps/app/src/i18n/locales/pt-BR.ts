...
export default {
  ...
  "plugins.desc": "Gerenciar `opencode.json` para plugins do projeto ou globais do Sofia.",
  ...
  "session.share_opencode_base_url": "URL base do Sofia",
  ...
  "settings.diag_opencode_binary": "Binário Sofia: {binary}",
  ...
  "settings.opencode_cache": "Cache do Sofia",
  ...
  "settings.opencode_engine_label": "Engine Sofia",
  ...
  "settings.opencode_sdk_title": "Engine Sofia",
  ...
  "system.reload_body_config": "O Sofia lê opencode.json na inicialização. Recarregue o engine para aplicar mudanças de configuração.",
  ...
  "system.reload_body_plugins": "O Sofia carrega plugins npm na inicialização. Recarregue o engine para aplicar mudanças no opencode.json.",
