...
export default {
  ...
  "den.signin_link_hint": "Se o navegador não redirecionar de volta para o Sofia App automaticamente, cole o link de login ou código de uso único do OpenWork Cloud aqui.",
