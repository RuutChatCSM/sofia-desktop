...
export const openNotificationCenterEvent = "sofia-open-notification-center";

/** Window event that asks the marketplace view to highlight a plugin. */
export const openMarketplacePluginEvent = "sofia-open-marketplace-plugin";

const PENDING_MARKETPLACE_PLUGIN_KEY = "sofia:pending-marketplace-plugin";
...
const ALERT_TOAST_ID = "sofia-notification-alert";
