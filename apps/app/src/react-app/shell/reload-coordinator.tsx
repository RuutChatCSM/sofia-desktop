...
export const orgOnboardingVisibilityEvent = "sofia-org-onboarding-visibility";
...
export function ReloadCoordinatorProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    window.addEventListener("sofia-reload-required", handler);

    return () => window.removeEventListener("sofia-reload-required", handler);
