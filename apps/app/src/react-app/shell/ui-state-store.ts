...
export const PERSISTED_UI_STATE_KEY = "sofia:ui-state:v1";
const SIDEBAR_COOKIE_NAME = "sidebar_state";
const LEGACY_WORKSPACE_LEFT_SIDEBAR_WIDTH_KEY = "sofia.workspace-shell.left-width.v1";
const LEGACY_WORKSPACE_RIGHT_SIDEBAR_EXPANDED_KEY = "sofia.workspace-shell.right-expanded.v3";
const LEGACY_WORKSPACE_RIGHT_SIDEBAR_WIDTH_KEY = "sofia.workspace-shell.right-width.v1";
...
function syncApplicationMenuVisible(visible: boolean): void {
  void globalThis.window?.__SOFIA_ELECTRON__?.invokeDesktop?.("__setApplicationMenuVisible", visible);
}
