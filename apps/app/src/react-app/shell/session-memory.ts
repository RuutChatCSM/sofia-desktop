...
const SESSION_BY_WORKSPACE_KEY = "sofia.react.sessionByWorkspace";
const WORKSPACE_ORDER_KEY = "sofia.react.workspaceOrder";
const WORKSPACE_PROJECT_DIMENSION_KEY = "sofia.react.workspaceProjectDimension";
