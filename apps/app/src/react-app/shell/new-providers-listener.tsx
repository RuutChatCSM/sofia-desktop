...
const SEEN_KEY = "sofia.seenProviderIds";
const PENDING_MODEL_PICKER_KEY = "sofia.pendingModelPickerProviderIds";
const NEW_PROVIDERS_DEDUPE_KEY = "new-providers";

/** Custom event to request the model picker to open. */
export const openModelPickerEvent = "sofia-open-model-picker";
/** Custom event to request the provider auth (connect API keys) modal to open. */
export const openProviderAuthEvent = "sofia-open-provider-auth";
