...
import type { SofiaSessionGroupState } from "@/app/lib/sofia-server";
...
const MIGRATION_PREFIX = "sofia.sessionGroups.migrated.v2";
...
function serverStateFromWorkspaceState(state: WorkspaceGroupState): SofiaSessionGroupState {
  return {
