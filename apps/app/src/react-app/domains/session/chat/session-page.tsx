...
export function SessionPage(props: SessionPageProps) {
  ...
  const openBrowserUrlControlAction = useMemo<SofiaControlAction>(() => ({
    ...
    description: "Create or select an Sofia built-in browser tab, navigate it to a URL, and return the CDP handle for browser automation.",
  ...
  const focusWorkbenchSessionControlAction = useMemo<SofiaControlAction>(() => ({
    ...
    args: [{
      ...
      type: "string",
      required: true,
      description: "Session id from the Sofia context resources or conversation tabs.",
    }],
    execute: (args) => {
