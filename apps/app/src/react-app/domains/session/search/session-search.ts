import type { SofiaSessionMessage } from "@/app/lib/sofia-server";
...
function toCacheEntry(updatedAt: number, messages: SofiaSessionMessage[]): CacheEntry {
