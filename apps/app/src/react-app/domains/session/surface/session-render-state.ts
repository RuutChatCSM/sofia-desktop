...
export function resolveRenderedSessionSnapshot(input: {
  sessionId: string;
  currentSnapshot: SofiaSessionSnapshot | null | undefined;
  cachedRendered: { sessionId: string; snapshot: SofiaSessionSnapshot } | null | undefined;
}) {
...
export function deriveRenderedSessionMessages(input: {
  ...
  snapshot: SofiaSessionSnapshot | null | undefined;
}) {
