...
const DEFAULT_COMPOSER_CONTROL_TEXT = "Help me outline the next Sofia task.";
const SESSION_SURFACE_SELECTOR = "[data-session-surface-id]";
const MARKDOWN_PRIMITIVE_EVAL_TEXT = `# Markdown proof heading

This shared renderer keeps **bold proof text**, inline \`renderMarkdownHtml\`, and [Sofia link](https://sofia.ruut.chat) readable in one message.
  ...
  const messages: UIMessage[] = [
    ...
    },
    {
      ...
      parts: [
        ...
        {
          type: "text",
          text: "Your plan is drafted — details in [Sofia](https://sofia.ruut.chat). Search token: chat-transcript-proof.",
        },
      ],
...
function messageToReadableText(message: UIMessage) {
  const header = message.role === "user" ? "You" : message.role === "assistant" ? "Sofia" : message.role;
