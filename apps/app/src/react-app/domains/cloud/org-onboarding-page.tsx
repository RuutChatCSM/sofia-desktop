      ...
      <Page>
        ...
        <PageContainer>
          <PageHeader>
            ...
            <PageDescription>
              Restart Sofia once to finish applying {orgName || "your workspace"}&apos;s name and app icon everywhere.
            </PageDescription>
      ...
      <PageContainer>
        ...
        <PageHeader>
          {prepared ? (
            ...
            >
              <CheckCircle2 className="size-3.5" />
              Setup complete — Sofia prepared this workspace
            </div>
          ) : null}
          <PageTitle>
