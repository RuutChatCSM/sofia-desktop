...
export type ClaudePluginImportModalProps = {
  open: boolean;
  onClose: () => void;
  onPreview: (url: string) => Promise<SofiaClaudePluginPreview>;
...
type ModalState = {
  url: string;
  preview: SofiaClaudePluginPreview | null;
...
type ModalAction =
  | Partial<ModalState>
  | "reset"
  | { kind: "preview-success"; url: string; preview: SofiaClaudePluginPreview };
