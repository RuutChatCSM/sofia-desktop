...
export type ExtensionDetailModalProps = {
  ...
  /** Show the local stdio wrapper setup used by the Sofia UI MCP. */
  uiControl?: boolean;
  connected?: boolean;
...
const taxonomyDesc: Record<ExtensionTaxonomy, string> = {
  ...
  plugin: "Extends Sofia with additional capabilities managed by your organization.",
};
      ...
      <Card variant="outline" size="sm">
        ...
        <CardContent>
          <div className="flex flex-col gap-2 text-sm leading-relaxed text-muted-foreground">
            <div>Sofia desktop starts a private localhost bridge automatically.</div>
