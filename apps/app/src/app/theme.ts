...
const THEME_PREF_KEY = "sofia.react.settings.theme-mode";
const LEGACY_THEME_PREF_KEYS = ["sofia.themePref"];
...
const syncNativeTheme = (mode: ThemeMode) => {
  ...
  void window.__SOFIA_ELECTRON__?.invokeDesktop?.("__setNativeTheme", mode);
};
