...
const DESKTOP_SIGN_IN_STARTED_AT_KEY = "sofia.den.desktopSignInStartedAt";
const ORG_SELECTION_PENDING_KEY = "sofia.den.orgSelectionPendingAt";
const ORG_SELECTION_SUGGESTION_KEY = "sofia.den.orgSelectionSuggestion";
