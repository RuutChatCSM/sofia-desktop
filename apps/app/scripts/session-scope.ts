...
const starterRoot = "/Users/test/Sofia/starter";
const otherRoot = "/Users/test/Sofia/second";
...
try {
  ...
  step("windows create and list use the same transport directory", () => {
    ...
    const winRoot = String.raw`C:\Users\Test\Sofia\starter`;
    ...
    const verbatimDriveRoot = String.raw`\\?\C:\Users\Test\Sofia\starter`;
    assert.equal(toSessionTransportDirectory(verbatimDriveRoot), String.raw`C:\Users\Test\Sofia\starter`);
    assert.equal(describeDirectoryScope(verbatimDriveRoot).normalized, "c:/users/test/sofia/starter");
  });
