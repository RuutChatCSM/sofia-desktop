...
import { parseAutomationProposal } from "../src/components/tools/sofia-automation-proposal";
...
describe("Automation proposal card", () => {
  test("reads a proposal out of an sofia_execute result, string or object", () => {
