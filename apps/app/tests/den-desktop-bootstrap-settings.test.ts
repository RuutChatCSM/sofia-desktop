...
describe("desktop Den bootstrap settings", () => {
  ...
  test("reads the desktop base URL from bootstrap instead of stale localStorage", async () => {
    window.localStorage.setItem("sofia.den.baseUrl", "https://stale.example.com");
    window.localStorage.setItem("sofia.den.apiBaseUrl", "https://api.example.com");
  ...
  test("saves base URL changes to bootstrap and clears legacy endpoint storage", async () => {
    ...
    expect(window.localStorage.getItem("sofia.den.baseUrl")).toBeNull();
    expect(window.localStorage.getItem("sofia.den.apiBaseUrl")).toBeNull();
