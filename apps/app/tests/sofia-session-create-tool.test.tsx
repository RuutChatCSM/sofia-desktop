...
import { SofiaSessionCreateTool } from "../src/components/tools/sofia-session-create";
...
describe("SofiaSessionCreateTool", () => {
    ...
    const html = renderToStaticMarkup(
      <MemoryRouter>
        <MessageListProvider
          ...
          onMcpRetry={noop}
        >
          <SofiaSessionCreateTool part={sessionCreatePart()} />
        </MessageListProvider>
      </MemoryRouter>,
    );

    expect(html).toContain("data-sofia-session-create-card");
