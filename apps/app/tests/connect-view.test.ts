...
function cloudHealth(usable: boolean): SofiaCloudMcpHealth {
  return {
    ...
    desired: { present: true, name: "sofia-cloud", revision: "rev", config: null, token: { present: true, metadata: {} } },
    ...
    tools: {
      ...
      present: usable ? ["sofia-cloud_search_capabilities", "sofia-cloud_execute_capability", "other_tool"] : ["sofia-cloud_search_capabilities"],
