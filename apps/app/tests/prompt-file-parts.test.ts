...
describe("first-line local file parts", () => {
  test("detects tilde paths in the first line", () => {
    const parts = firstLineLocalFileParts(
      "check ~/code/research/sofia-users/list.csv\nits a list of unique email domains",
      "/Users/omar/code/sofia",
    );
    ...
    expect(parts).toEqual([
      {
        type: "file",
        mime: "text/plain",
        url: "file:///Users/omar/code/research/sofia-users/list.csv",
        filename: "list.csv",
      },
    ]);
  });
  ...
  test("only detects paths from the first line", () => {
    const parts = firstLineLocalFileParts(
      "summarize this\n~/code/research/sofia-users/list.csv",
      "/Users/omar/code/sofia",
    );
  ...
  test("detects Windows absolute paths in the first line", () => {
    expect(firstLineLocalFileParts("check C:\\Users\\omar\\list.csv", "C:/Users/omar/code/sofia")).toEqual([
      {
        type: "file",
        mime: "text/plain",
...
describe("slash-command parsing", () => {
  ...
  test("does not parse absolute file paths as commands", () => {
    expect(parseSlashCommandInvocation("/Users/omar/code/sofia/apps/app/src/file.ts\nwhy does this fail?")).toBeNull();
...
describe("Connect skill slash commands", () => {
  test("uses the skill trigger and preserves the remote capability identity", () => {
    const [option] = connectSkillSlashCommandOptions([{
      ...
      path: "sofia-connect://marketplace_1/plugin_1/skill_1",
    ...
    expect(
      connectSkillSlashCommandOptions([
        ...
        },
        {
          name: "Unresolved",
          trigger: "unresolved",
          path: "sofia-connect://marketplace_1/plugin_1/skill_2",
          origin: "sofia-connect",
        },
      ]),
    ).toEqual([]);
