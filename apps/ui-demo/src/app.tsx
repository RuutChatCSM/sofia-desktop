    ...
    <main className="app-shell">
      ...
      <section className="hero-card panel">
        <div className="hero-copy">
          <span className="eyebrow">Sofia UI demo</span>
          ...
          <p>
            ...
            the gradients that `@sofia/ui/react` will render anywhere else in the repo.
          </p>
        </div>
      ...
      <section className="footer-grid">
        ...
        <div className="panel code-panel">
          ...
          <div className="pill-stack">
            <code className="import-pill">@sofia/ui/react</code>
          </div>
          <pre>{`import { PaperMeshGradient, PaperGrainGradient } from "@sofia/ui/react"
    ...
    <article className="panel preview-card">
      <div className="gradient-surface">
        ...
        <div className="surface-copy">
          <span className="eyebrow on-dark">@sofia/ui/react</span>
          <h2>{title}</h2>
          <p>{subtitle}</p>
        </div>
      </div>
