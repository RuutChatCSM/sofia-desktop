...
Add self-serve SCIM to `ee/apps/den-api` so an organization in Sofia Cloud can:
...
For Sofia Cloud, the safer stance is:
...
1. Are Sofia identities allowed to be globally shared across orgs when SCIM emails match?
